...
# This file is automatically run by Fwego when the plugin is built into a Dockerfile.
...
# Any install steps that will modify things in Fwego's data volume should instead
...
# Fwego will automatically install this python module for you so you should not
