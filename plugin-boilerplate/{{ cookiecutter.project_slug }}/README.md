...
A Fwego plugin can be used to extend or change the functionality of Fwego.
...
2. `docker-compose.multi-service.yml` - This is a more complex compose file which runs
   each of the Fwego services with your plugin installed in separate containers all
...
4. `docker-compose.dev.yml` - This is a development compose file which
   runs a Fwego all-in-one image with your plugin installed in development mode.
