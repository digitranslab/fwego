parser grammar FwegoFormula;

options { tokenVocab=FwegoFormulaLexer; }
...
// The core recursive grammar definition for the Fwego Formula language. Given a
...
// The CAPITAL_LETTER_VARIABLES are tokens defined in the FwegoFormulaLexer.g4 file.
