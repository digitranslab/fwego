...
} from '@fwego/modules/database/utils/duration'
import {
...
import {
  parseNumberValue,
  formatNumberValue,
} from '@fwego/modules/database/utils/number'
...
import FieldNumberSubForm from '@fwego/modules/database/components/field/FieldNumberSubForm'
import FieldAutonumberSubForm from '@fwego/modules/database/components/field/FieldAutonumberSubForm'
import FieldDurationSubForm from '@fwego/modules/database/components/field/FieldDurationSubForm'
import FieldRatingSubForm from '@fwego/modules/database/components/field/FieldRatingSubForm'
import FieldTextSubForm from '@fwego/modules/database/components/field/FieldTextSubForm'
import FieldLongTextSubForm from '@fwego/modules/database/components/field/FieldLongTextSubForm'
import FieldDateSubForm from '@fwego/modules/database/components/field/FieldDateSubForm'
import FieldLinkRowSubForm from '@fwego/modules/database/components/field/FieldLinkRowSubForm'
import FieldSelectOptionsSubForm from '@fwego/modules/database/components/field/FieldSelectOptionsSubForm'
import FieldCollaboratorSubForm from '@fwego/modules/database/components/field/FieldCollaboratorSubForm'
import FieldPasswordSubForm from '@fwego/modules/database/components/field/FieldPasswordSubForm'

import GridViewFieldText from '@fwego/modules/database/components/view/grid/fields/GridViewFieldText'
import GridViewFieldLongText from '@fwego/modules/database/components/view/grid/fields/GridViewFieldLongText'
import GridViewFieldRichText from '@fwego/modules/database/components/view/grid/fields/GridViewFieldRichText'
import GridViewFieldURL from '@fwego/modules/database/components/view/grid/fields/GridViewFieldURL'
import GridViewFieldEmail from '@fwego/modules/database/components/view/grid/fields/GridViewFieldEmail'
import GridViewFieldLinkRow from '@fwego/modules/database/components/view/grid/fields/GridViewFieldLinkRow'
import GridViewFieldNumber from '@fwego/modules/database/components/view/grid/fields/GridViewFieldNumber'
import GridViewFieldRating from '@fwego/modules/database/components/view/grid/fields/GridViewFieldRating'
import GridViewFieldBoolean from '@fwego/modules/database/components/view/grid/fields/GridViewFieldBoolean'
import GridViewFieldDate from '@fwego/modules/database/components/view/grid/fields/GridViewFieldDate'
import GridViewFieldDateReadOnly from '@fwego/modules/database/components/view/grid/fields/GridViewFieldDateReadOnly'
import GridViewFieldFile from '@fwego/modules/database/components/view/grid/fields/GridViewFieldFile'
import GridViewFieldSingleSelect from '@fwego/modules/database/components/view/grid/fields/GridViewFieldSingleSelect'
import GridViewFieldMultipleSelect from '@fwego/modules/database/components/view/grid/fields/GridViewFieldMultipleSelect'
import GridViewFieldPhoneNumber from '@fwego/modules/database/components/view/grid/fields/GridViewFieldPhoneNumber'
import GridViewFieldDuration from '@fwego/modules/database/components/view/grid/fields/GridViewFieldDuration'
import GridViewFieldMultipleCollaborators from '@fwego/modules/database/components/view/grid/fields/GridViewFieldMultipleCollaborators'
import GridViewFieldUUID from '@fwego/modules/database/components/view/grid/fields/GridViewFieldUUID'
import GridViewFieldAutonumber from '@fwego/modules/database/components/view/grid/fields/GridViewFieldAutonumber'
import GridViewFieldLastModifiedBy from '@fwego/modules/database/components/view/grid/fields/GridViewFieldLastModifiedBy'
import GridViewFieldPassword from '@fwego/modules/database/components/view/grid/fields/GridViewFieldPassword'

import FunctionalGridViewFieldText from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldText'
import FunctionalGridViewFieldDuration from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldDuration'
...
import FunctionalGridViewFieldRichText from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldRichText'
import FunctionalGridViewFieldLinkRow from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldLinkRow'
...
import FunctionalGridViewFieldRating from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldRating'
...
import FunctionalGridViewFieldFile from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldFile'
import FunctionalGridViewFieldSingleSelect from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldSingleSelect'
import FunctionalGridViewFieldMultipleSelect from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldMultipleSelect'
import FunctionalGridViewFieldFormula from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldFormula'
import FunctionalGridViewFieldMultipleCollaborators from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldMultipleCollaborators'
import FunctionalGridViewFieldURL from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldURL'
import FunctionalGridViewFieldUUID from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldUUID'
import FunctionalGridViewFieldAutonumber from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldAutonumber'
import FunctionalGridViewFieldLastModifiedBy from '@fwego/modules/database/components/view/grid/fields/FunctionalGridViewFieldLastModifiedBy'
import FunctionalGridVIewFieldPassword from '@fwego/modules/database/components/view/grid/fields/FunctionalGridVIewFieldPassword.vue'
...
import RowEditFieldRichText from '@fwego/modules/database/components/row/RowEditFieldRichText'
import RowEditFieldURL from '@fwego/modules/database/components/row/RowEditFieldURL'
import RowEditFieldEmail from '@fwego/modules/database/components/row/RowEditFieldEmail'
import RowEditFieldLinkRow from '@fwego/modules/database/components/row/RowEditFieldLinkRow'
import RowEditFieldNumber from '@fwego/modules/database/components/row/RowEditFieldNumber'
import RowEditFieldDuration from '@fwego/modules/database/components/row/RowEditFieldDuration'
import RowEditFieldRating from '@fwego/modules/database/components/row/RowEditFieldRating'
import RowEditFieldBoolean from '@fwego/modules/database/components/row/RowEditFieldBoolean'
import RowEditFieldDate from '@fwego/modules/database/components/row/RowEditFieldDate'
import RowEditFieldDateReadOnly from '@fwego/modules/database/components/row/RowEditFieldDateReadOnly'
import RowEditFieldFile from '@fwego/modules/database/components/row/RowEditFieldFile'
import RowEditFieldSingleSelect from '@fwego/modules/database/components/row/RowEditFieldSingleSelect'
import RowEditFieldMultipleSelect from '@fwego/modules/database/components/row/RowEditFieldMultipleSelect'
import RowEditFieldPhoneNumber from '@fwego/modules/database/components/row/RowEditFieldPhoneNumber'
import RowEditFieldMultipleCollaborators from '@fwego/modules/database/components/row/RowEditFieldMultipleCollaborators'
import RowEditFieldUUID from '@fwego/modules/database/components/row/RowEditFieldUUID'
import RowEditFieldAutonumber from '@fwego/modules/database/components/row/RowEditFieldAutonumber'
import RowEditFieldLastModifiedBy from '@fwego/modules/database/components/row/RowEditFieldLastModifiedBy'
import RowEditFieldPassword from '@fwego/modules/database/components/row/RowEditFieldPassword'

import RowCardFieldBoolean from '@fwego/modules/database/components/card/RowCardFieldBoolean'
import RowCardFieldDate from '@fwego/modules/database/components/card/RowCardFieldDate'
import RowCardFieldDuration from '@fwego/modules/database/components/card/RowCardFieldDuration'
import RowCardFieldEmail from '@fwego/modules/database/components/card/RowCardFieldEmail'
import RowCardFieldFile from '@fwego/modules/database/components/card/RowCardFieldFile'
import RowCardFieldFormula from '@fwego/modules/database/components/card/RowCardFieldFormula'
import RowCardFieldLinkRow from '@fwego/modules/database/components/card/RowCardFieldLinkRow'
import RowCardFieldMultipleSelect from '@fwego/modules/database/components/card/RowCardFieldMultipleSelect'
import RowCardFieldNumber from '@fwego/modules/database/components/card/RowCardFieldNumber'
import RowCardFieldRating from '@fwego/modules/database/components/card/RowCardFieldRating'
import RowCardFieldPhoneNumber from '@fwego/modules/database/components/card/RowCardFieldPhoneNumber'
import RowCardFieldSingleSelect from '@fwego/modules/database/components/card/RowCardFieldSingleSelect'
import RowCardFieldText from '@fwego/modules/database/components/card/RowCardFieldText'
import RowCardFieldRichText from '@fwego/modules/database/components/card/RowCardFieldRichText'
import RowCardFieldURL from '@fwego/modules/database/components/card/RowCardFieldURL'
import RowCardFieldMultipleCollaborators from '@fwego/modules/database/components/card/RowCardFieldMultipleCollaborators'
import RowCardFieldUUID from '@fwego/modules/database/components/card/RowCardFieldUUID'
import RowCardFieldAutonumber from '@fwego/modules/database/components/card/RowCardFieldAutonumber'
import RowCardFieldLastModifiedBy from '@fwego/modules/database/components/card/RowCardFieldLastModifiedBy'
import RowCardFieldPassword from '@fwego/modules/database/components/card/RowCardFieldPassword'

import RowHistoryFieldText from '@fwego/modules/database/components/row/RowHistoryFieldText'
import RowHistoryFieldRichText from '@fwego/modules/database/components/row/RowHistoryFieldRichText'
import RowHistoryFieldDate from '@fwego/modules/database/components/row/RowHistoryFieldDate'
import RowHistoryFieldNumber from '@fwego/modules/database/components/row/RowHistoryFieldNumber'
import RowHistoryFieldDuration from '@fwego/modules/database/components/row/RowHistoryFieldDuration'
import RowHistoryFieldMultipleCollaborators from '@fwego/modules/database/components/row/RowHistoryFieldMultipleCollaborators'
import RowHistoryFieldFile from '@fwego/modules/database/components/row/RowHistoryFieldFile'
import RowHistoryFieldMultipleSelect from '@fwego/modules/database/components/row/RowHistoryFieldMultipleSelect'
import RowHistoryFieldSingleSelect from '@fwego/modules/database/components/row/RowHistoryFieldSingleSelect'
import RowHistoryFieldBoolean from '@fwego/modules/database/components/row/RowHistoryFieldBoolean'
import RowHistoryFieldLinkRow from '@fwego/modules/database/components/row/RowHistoryFieldLinkRow'
import RowHistoryFieldPassword from '@fwego/modules/database/components/row/RowHistoryFieldPassword'

import FormViewFieldLinkRow from '@fwego/modules/database/components/view/form/FormViewFieldLinkRow'
import FormViewFieldMultipleLinkRow from '@fwego/modules/database/components/view/form/FormViewFieldMultipleLinkRow'
import FormViewFieldMultipleSelectCheckboxes from '@fwego/modules/database/components/view/form/FormViewFieldMultipleSelectCheckboxes'
import FormViewFieldSingleSelectRadios from '@fwego/modules/database/components/view/form/FormViewFieldSingleSelectRadios'
...
import GridViewFieldFormula from '@fwego/modules/database/components/view/grid/fields/GridViewFieldFormula'
import FieldFormulaSubForm from '@fwego/modules/database/components/field/FieldFormulaSubForm'
import FieldLookupSubForm from '@fwego/modules/database/components/field/FieldLookupSubForm'
import FieldCountSubForm from '@fwego/modules/database/components/field/FieldCountSubForm'
import FieldRollupSubForm from '@fwego/modules/database/components/field/FieldRollupSubForm'
import RowEditFieldFormula from '@fwego/modules/database/components/row/RowEditFieldFormula'
...
import ViewFilterTypeNumber from '@fwego/modules/database/components/view/ViewFilterTypeNumber.vue'
import ViewFilterTypeDuration from '@fwego/modules/database/components/view/ViewFilterTypeDuration.vue'
import FormViewFieldOptionsAllowedSelectOptions from '@fwego/modules/database/components/view/form/FormViewFieldOptionsAllowedSelectOptions'
...
export class BooleanFieldType extends FieldType {
  ...
  getSortIndicator() {
    return ['icon', 'fwego-icon-circle-empty', 'fwego-icon-circle-checked']
  }
