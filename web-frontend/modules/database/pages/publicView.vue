...
import languageDetection from '@fwego/modules/core/mixins/languageDetection'
import { keyboardShortcutsToPriorityEventBus } from '@fwego/modules/core/utils/events'
