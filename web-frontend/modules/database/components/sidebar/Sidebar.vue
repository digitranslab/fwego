...
import SidebarItem from '@fwego/modules/database/components/sidebar/SidebarItem'
import SidebarApplication from '@fwego/modules/core/components/sidebar/SidebarApplication'
import CreateTableModal from '@fwego/modules/database/components/table/CreateTableModal'
