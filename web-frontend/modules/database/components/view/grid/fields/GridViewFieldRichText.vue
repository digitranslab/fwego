...
<template>
  ...
  >
    ...
    <i
      ...
      class="fwego-icon-enlarge grid-field-rich-text__textarea-expand-icon"
      @click="
...
<script>
import RichTextEditor from '@fwego/modules/core/components/editor/RichTextEditor.vue'
...
import FieldRichTextModal from '@fwego/modules/database/components/view/FieldRichTextModal'
