...
import GridViewSection from '@fwego/modules/database/components/view/grid/GridViewSection'
import HorizontalResize from '@fwego/modules/core/components/HorizontalResize'
import GridViewRowDragging from '@fwego/modules/database/components/view/grid/GridViewRowDragging'
...
import copyPasteHelper from '@fwego/modules/database/mixins/copyPasteHelper'
import GridViewRowsAddContext from '@fwego/modules/database/components/view/grid/fields/GridViewRowsAddContext'
...
export default {
  ...
  watch: {
    ...
    row: {
      ...
      handler(newRow, prevRow) {
        ...
        // https://github.com/digitranslab/fwego/-/issues/1765. This handler ensure
  ...
  methods: {
    ...
    async pasteData(textData, jsonData, rowIndex, fieldIndex) {
      ...
      const pageSizeLimit = this.$config.FWEGO_ROW_PAGE_SIZE_LIMIT
