...
<script>
import baseFormViewMode from '@fwego/modules/database/mixins/baseFormViewMode'
import FormPageField from '@fwego/modules/database/components/view/form/FormPageField'
import FormViewPoweredBy from '@fwego/modules/database/components/view/form/FormViewPoweredBy'
import FormViewSubmitted from '@fwego/modules/database/components/view/form/FormViewSubmitted'
