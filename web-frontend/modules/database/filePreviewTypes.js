...
import PreviewImage from '@fwego/modules/database/components/preview/PreviewImage'
import PreviewVideo from '@fwego/modules/database/components/preview/PreviewVideo'
import PreviewAudio from '@fwego/modules/database/components/preview/PreviewAudio'
import PreviewPDFBrowser from '@fwego/modules/database/components/preview/PreviewPDFBrowser'
import PreviewGoogleDocs from '@fwego/modules/database/components/preview/PreviewGoogleDocs'
...
export class GoogleDocFilePreview extends FilePreviewType {
  ...
  isCompatible(mimeType, fileName) {
    if (this.app.$config.FWEGO_DISABLE_GOOGLE_DOCS_FILE_PREVIEW) {
      return false
    }
