  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <i class="fwego-icon-paragraph"></i>
        </button>
      </div>
      <div
      ...
      >
        <button
          ...
          "
        >
          <i class="fwego-icon-heading-1"></i>
        </button>
      </div>
      <div
      ...
      >
        <button
          ...
          "
        >
          <i class="fwego-icon-heading-2"></i>
        </button>
      </div>
      <div
      ...
      >
        <button
          ...
          "
        >
          <i class="fwego-icon-heading-3"></i>
        </button>
      </div>
      <div
      ...
      >
        ...
        >
          <i class="fwego-icon-ordered-list"></i>
        </button>
      </div>
      <div
  ...
  computed: {
    ...
    activeNodeIcon() {
      switch (this.activeNode) {
        case 'h1':
          return 'fwego-icon-heading-1'
        case 'h2':
          return 'fwego-icon-heading-2'
        case 'h3':
          return 'fwego-icon-heading-3'
        case 'code':
          return 'iconoir-code'
        case 'ol':
          return 'fwego-icon-ordered-list'
        case 'ul':
          return 'iconoir-list'
        case 'tl':
          return 'iconoir-task-list'
        default:
          return 'fwego-icon-paragraph'
      }
    },
  },
  methods: {
