...
import CreateSnapshotForm from '@fwego/modules/core/components/snapshots/CreateSnapshotForm'
import SnapshotListItem from '@fwego/modules/core/components/snapshots/SnapshotListItem'
import SnapshotsService from '@fwego/modules/core/services/snapshots'
import job from '@fwego/modules/core/mixins/job'
import { CreateSnapshotJobType } from '@fwego/modules/core/jobTypes'
...
export default {
  ...
  computed: {
    ...
    maxSnapshots() {
      return parseInt(this.$config.FWEGO_MAX_SNAPSHOTS_PER_GROUP)
    },
