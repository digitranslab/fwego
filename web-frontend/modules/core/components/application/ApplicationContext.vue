    ...
    <ul class="context__menu">
      ...
      >
        <a class="context__menu-item-link" @click="openSnapshots">
          <i class="context__menu-item-icon fwego-icon-history"></i>
...
import SnapshotsModal from '@fwego/modules/core/components/snapshots/SnapshotsModal'
import SidebarDuplicateApplicationContextItem from '@fwego/modules/core/components/sidebar/SidebarDuplicateApplicationContextItem.vue'
