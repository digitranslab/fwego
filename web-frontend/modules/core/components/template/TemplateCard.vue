  ...
  <a class="template__card" @click="$emit('click', $event)">
    ...
    <div v-else class="template__card-more">
      <img
        ...
        src="@fwego/modules/core/assets/images/template_more_icon.svg?data"
...
<script>
import TemplateIllustration from '@fwego/modules/core/components/template/TemplateIllustration'
