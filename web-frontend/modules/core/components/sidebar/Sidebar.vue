  ...
  <div class="sidebar" :class="{ 'sidebar--collapsed': collapsed }">
    ...
    <template v-if="!showAdmin">
      ...
      >
        ...
        <i
          v-show="!collapsed"
          class="sidebar__workspaces-selector-icon fwego-icon-up-down-arrows"
        ></i>
      </a>
      <SidebarUserContext
...
import SidebarUserContext from '@fwego/modules/core/components/sidebar/SidebarUserContext'
import SidebarWithWorkspace from '@fwego/modules/core/components/sidebar/SidebarWithWorkspace'
import SidebarWithoutWorkspace from '@fwego/modules/core/components/sidebar/SidebarWithoutWorkspace'
import SidebarAdmin from '@fwego/modules/core/components/sidebar/SidebarAdmin'
import SidebarFoot from '@fwego/modules/core/components/sidebar/SidebarFoot'
import SidebarMenu from '@fwego/modules/core/components/sidebar/SidebarMenu'
