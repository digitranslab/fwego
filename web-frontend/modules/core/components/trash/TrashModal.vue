...
import TrashService from '@fwego/modules/core/services/trash'
import TrashSidebar from '@fwego/modules/core/components/trash/TrashSidebar'
import TrashContent from '@fwego/modules/core/components/trash/TrashContents'
