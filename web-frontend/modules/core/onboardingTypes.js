...
import UserPreview from '@fwego/modules/core/components/onboarding/UserPreview'
import InviteStep from '@fwego/modules/core/components/onboarding/InviteStep'
import MoreStep from '@fwego/modules/core/components/onboarding/MoreStep'
import TeamStep from '@fwego/modules/core/components/onboarding/TeamStep'
import WorkspaceStep from '@fwego/modules/core/components/onboarding/WorkspaceStep'
import AppLayoutPreview from '@fwego/modules/core/components/onboarding/AppLayoutPreview'
...
import { MemberRoleType } from '@fwego/modules/database/roleTypes'
...
export class MoreOnboardingType extends OnboardingType {
  ...
  async complete(data, responses) {
    ...
    if (share) {
      ...
      await AuthService(this.app.$client).shareOnboardingDetailsWithFwego(
        team,
        moreData.role,
...
export class InviteOnboardingType extends OnboardingType {
  ...
  async complete(data, responses) {
    ...
    const acceptUrl = `${this.app.$config.FWEGO_EMBEDDED_SHARE_URL}/workspace-invitation`
