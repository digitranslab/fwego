...
import { upperCaseFirst } from '@fwego/modules/core/utils/string'
import { makeRefreshAuthInterceptor } from '@fwego/modules/core/plugins/clientAuthRefresh'
...
const prepareRequestHeaders = (store) => (config) => {
  ...
  if (store.getters['auth/isAuthenticated']) {
    ...
    // If we are logged with Fwego user and with a user source user
    ...
    // We access the data with the permission of the currently logged Fwego user
