          ...
          <div class="formula-field__body">
            <div class="formula-field__items">
              <ul class="formula-field__item-group">
                ...
                <li class="formula-field__item">
                  <a href="#" class="formula-field__item-link">
                    <i class="fwego-icon-hashtag formula-field__item-icon" />
                    Number
                  </a>
                </li>
                <li class="formula-field__item">
...
“Hello” + “World” == “HelloWorld”</code></pre>
          ...
          <div class="card" style="width: 320px">
            ...
            <div class="card__fields">
              ...
              <div class="card__field">
                ...
                <div class="card__field-value">
                  <div class="card-text">
                    <a href="#">developers@digi-trans.org</a>
                  </div>
                </div>
              </div>
              <div class="card__field">
                      ...
                      <div class="data-table__table-cell-content">
                        <div class="data-table__more-wrapper">
                          <a href="#" class="data-table__more">
                            <i
                              class="data-table__more-icon fwego-icon-more-horizontal"
                            ></i>
                          </a>
                        </div>
                      </div>
        ...
        <div class="margin-bottom-3">
          <h2>Presentations</h2>
          <Presentation
            title="My fwego integration"
            subtitle="Local fwego integration"
            class="margin-bottom-2"
          />
          <Presentation
            title="My fwego integration"
          ...
          <Presentation
            :image="image"
            title="My fwego integration"
            subtitle="Local fwego integration with a very long description"
            avatar-color="neutral"
            class="margin-bottom-2"
          />
        </div>
        ...
        <div class="margin-bottom-3">
          ...
          <br />
          <CallToAction icon="fwego-icon-plus">
...
import ColorPickerContext from '@fwego/modules/core/components/ColorPickerContext.vue'
import ColorPicker from '@fwego/modules/core/components/ColorPicker.vue'
import Paginator from '@fwego/modules/core/components/Paginator.vue'
