        ...
        >
          <!-- <li class="auth__action-link">
            <i18n path="signup.agreeTerms" tag="span">
              <a
                href="https://fwego.io/terms-and-conditions"
                target="_blank"
                @click.stop
                >{{ $t('signup.terms') }}
              </a>
              {{ $t('common.and') }}
              <a
                href="https://fwego.io/privacy-policy"
                target="_blank"
                @click.stop
...
import PasswordRegister from '@fwego/modules/core/components/auth/PasswordRegister'
import LangPicker from '@fwego/modules/core/components/LangPicker'
import LoginButtons from '@fwego/modules/core/components/auth/LoginButtons'
import LoginActions from '@fwego/modules/core/components/auth/LoginActions'
import workspaceInvitationToken from '@fwego/modules/core/mixins/workspaceInvitationToken'
import { EMAIL_VERIFICATION_OPTIONS } from '@fwego/modules/core/enums'
import EmailNotVerified from '@fwego/modules/core/components/auth/EmailNotVerified.vue'
