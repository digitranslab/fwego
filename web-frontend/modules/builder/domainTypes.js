...
import CustomDomainDetails from '@fwego/modules/builder/components/domain/CustomDomainDetails'
import CustomDomainForm from '@fwego/modules/builder/components/domain/CustomDomainForm'
import SubDomainForm from '@fwego/modules/builder/components/domain/SubDomainForm'
import SubDomainDetails from '@fwego/modules/builder/components/domain/SubDomainDetails'
...
export class SubDomainType extends DomainType {
  ...
  get options() {
    return this.app.$config.FWEGO_BUILDER_DOMAINS.map((domain) => ({
