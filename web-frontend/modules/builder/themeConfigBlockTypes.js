...
import ColorThemeConfigBlock from '@fwego/modules/builder/components/theme/ColorThemeConfigBlock'
import TypographyThemeConfigBlock from '@fwego/modules/builder/components/theme/TypographyThemeConfigBlock'
import ButtonThemeConfigBlock from '@fwego/modules/builder/components/theme/ButtonThemeConfigBlock'
import LinkThemeConfigBlock from '@fwego/modules/builder/components/theme/LinkThemeConfigBlock'
import ImageThemeConfigBlock from '@fwego/modules/builder/components/theme/ImageThemeConfigBlock'
import PageThemeConfigBlock from '@fwego/modules/builder/components/theme/PageThemeConfigBlock'
import InputThemeConfigBlock from '@fwego/modules/builder/components/theme/InputThemeConfigBlock'
import TableThemeConfigBlock from '@fwego/modules/builder/components/theme/TableThemeConfigBlock'
import {
  resolveColor,
  colorRecommendation,
} from '@fwego/modules/core/utils/colors'
import {
  WIDTHS_NEW,
