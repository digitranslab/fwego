...
import GeneralSettings from '@fwego/modules/builder/components/settings/GeneralSettings'
import IntegrationSettings from '@fwego/modules/builder/components/settings/IntegrationSettings'
import ThemeSettings from '@fwego/modules/builder/components/settings/ThemeSettings'
import DomainsSettings from '@fwego/modules/builder/components/settings/DomainsSettings'
import UserSourcesSettings from '@fwego/modules/builder/components/settings/UserSourcesSettings'
