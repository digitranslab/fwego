...
<script>
import ThemeConfigBlock from '@fwego/modules/builder/components/theme/ThemeConfigBlock'
import { getParentMatchingPredicate } from '@fwego/modules/core/utils/dom'
