  ...
  <div>
    ...
    >
      <template #field-name="{ field }">
        <th
          :key="field.__id__"
          class="fwego-table__header-cell"
          :class="{
      ...
      <template #cell-content="{ rowIndex, value, field }">
        <td
          v-if="field.isOption"
          :key="field.name"
          class="fwego-table__cell property-option-form__table-option"
        >
          <Checkbox
            v-tooltip="
        ...
        <td
          v-else
          :key="field.name"
          class="fwego-table__cell property-option-form__table-property"
        >
...
<script>
import FwegoTable from '@fwego/modules/builder/components/elements/components/FwegoTable'
import form from '@fwego/modules/core/mixins/form'

export default {
  name: 'PropertyOptionForm',
  components: { FwegoTable },
  mixins: [form],
  props: {
    dataSource: {
      type: Object,
