...
import collectionElementForm from '@fwego/modules/builder/mixins/collectionElementForm'
import DeviceSelector from '@fwego/modules/builder/components/page/header/DeviceSelector.vue'
...
import ServiceSchemaPropertySelector from '@fwego/modules/core/components/services/ServiceSchemaPropertySelector.vue'
import DataSourceDropdown from '@fwego/modules/builder/components/dataSource/DataSourceDropdown.vue'
import PropertyOptionForm from '@fwego/modules/builder/components/elements/components/forms/general/settings/PropertyOptionForm'
