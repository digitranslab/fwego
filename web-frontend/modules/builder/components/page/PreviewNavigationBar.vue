...
<script>
import { splitPath } from '@fwego/modules/builder/utils/path'
import PreviewNavigationBarInput from '@fwego/modules/builder/components/page/PreviewNavigationBarInput'
import UserSelector from '@fwego/modules/builder/components/page/UserSelector'
import { mapActions } from 'vuex'
import { PAGE_PARAM_TYPE_VALIDATION_FUNCTIONS } from '@fwego/modules/builder/enums'
