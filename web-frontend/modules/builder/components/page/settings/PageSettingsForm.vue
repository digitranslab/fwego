...
import PageSettingsNameFormElement from '@fwego/modules/builder/components/page/settings/PageSettingsNameFormElement'
import PageSettingsPathFormElement from '@fwego/modules/builder/components/page/settings/PageSettingsPathFormElement'
import PageSettingsPathParamsFormElement from '@fwego/modules/builder/components/page/settings/PageSettingsPathParamsFormElement'
import {
  getPathParams,
  PATH_PARAM_REGEX,
  ILLEGAL_PATH_SAMPLE_CHARACTER,
  VALID_PATH_CHARACTERS,
} from '@fwego/modules/builder/utils/path'
import {
