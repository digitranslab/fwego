<template>
  <div class="local-fwego-adhoc-header__container">
...
import { getFilters, getOrderBy } from '@fwego/modules/database/utils/view'
...
export default {
  ...
  props: {
     ...
     * To access the Fwego field response, these need to be reduced down
