<template>
  <FormRow>
    <FormGroup
      :label="$t('localFwegoTableSelector.databaseFieldLabel')"
      small-label
      required
    >
      <Dropdown
    ...
    <FormGroup
      :label="$t('localFwegoTableSelector.tableFieldLabel')"
      small-label
      required
    >
      <Dropdown
    ...
    <FormGroup
      ...
      :label="$t('localFwegoTableSelector.viewFieldLabel')"
      small-label
      required
    >
      <Dropdown
      ...
      >
        <DropdownItem
          :name="$t('localFwegoTableSelector.chooseNoView')"
          :value="null"
          >{{ $t('localFwegoTableSelector.chooseNoView') }}</DropdownItem
        >
        <DropdownItem
          v-for="view in views"
          :key="view.id"
