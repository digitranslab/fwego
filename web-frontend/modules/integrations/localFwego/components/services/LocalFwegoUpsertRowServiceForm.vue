...
import FieldMappingForm from '@fwego/modules/integrations/localFwego/components/services/FieldMappingForm'
...
export default {
  name: 'LocalFwegoUpsertRowServiceForm',
  components: {
    LocalFwegoServiceForm,
    FieldMappingForm,
  },
  ...
  methods: {
    /**
     * When `LocalFwegoServiceForm` informs us that the table
    ...
    /**
     * When `LocalFwegoServiceForm` informs us that service specific
