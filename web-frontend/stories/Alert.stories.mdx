...
<Meta
    title="Fwego/Toasts & Alerts/Alerts"
...
<Canvas>
    ...
    <Story
        ...
        args={{
            ...
            title: 'Successfully updated profile',
            actions:
                '<ButtonIcon icon="fwego-icon-twitter"></ButtonIcon><ButtonIcon icon="fwego-icon-reddit"></ButtonIcon><ButtonIcon icon="fwego-icon-facebook"></ButtonIcon><ButtonIcon icon="fwego-icon-linkedin"></ButtonIcon>',
            width: 396,
        }}
        parameters={{
            design: config(designConfig),
