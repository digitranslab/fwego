...
from fwego_premium.license.exceptions import CantManuallyChangeSeatsError
from fwego_premium.license.features import PREMIUM
from fwego_premium.license.handler import LicenseHandler
from fwego_premium.license.registries import SeatUsageSummary
...
from fwego.core.models import Application, Settings, Workspace
from fwego.core.registries import email_context_registry, subject_type_registry
from fwego.core.trash.handler import TrashHandler
from fwego.core.user_files.handler import UserFileHandler
from fwego_enterprise.features import ENTERPRISE_SETTINGS, RBAC, SSO
from fwego_enterprise.license_types import EnterpriseLicenseType
from fwego_enterprise.role.default_roles import default_roles
from fwego_enterprise.role.handler import RoleAssignmentHandler
from fwego_enterprise.role.models import Role, RoleAssignment
from fwego_enterprise.role.seat_usage_calculator import (
...
def test_check_licenses_with_enterprise_license_sends_seat_data(
    ...
    with freeze_time("2021-07-01 12:00"):
        responses.add(
            responses.POST,
            "http://fwego-saas-backend:8000/api/saas/licenses/check/",
            json={
    ...
    responses.assert_call_count(
        "http://fwego-saas-backend:8000/api/saas/licenses/check/", 1
    )
...
@pytest.mark.django_db
@override_settings(DEBUG=True)
@patch("fwego_premium.license.handler.broadcast_to_users")
...
def test_enterprise_settings_feature_allow_co_branding_in_emails(data_fixture, tmpdir):
    ...
    with freeze_time("2023-02-01 01:23"):
        ...
        assert email_context["logo_additional_text"] == "by Fwego"
