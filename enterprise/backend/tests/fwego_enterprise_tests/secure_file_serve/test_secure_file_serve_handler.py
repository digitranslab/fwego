...
from fwego_enterprise.secure_file_serve.exceptions import SecureFileServeException
from fwego_enterprise.secure_file_serve.handler import (
    SecureFile,
    SecureFileServeHandler,
)
from fwego_enterprise.secure_file_serve.storage import (
...
@mock.patch("fwego_enterprise.secure_file_serve.handler.EnterpriseFileStorage")
...
def test_secure_file_handler_get_file_path_exists():
    ...
    with mock.patch(
        "fwego_enterprise.secure_file_serve.handler.get_default_storage"
    ) as get_storage_mock:
...
def test_secure_file_handler_get_file_path_does_not_exist():
    ...
    with mock.patch(
        "fwego.core.storage.get_default_storage"
