...
from fwego.contrib.database.object_scopes import DatabaseObjectScopeType
...
from fwego_enterprise.role.constants import ALLOWED_SUBJECT_TYPE_BY_PRIORITY
...
@patch("fwego.ws.signals.broadcast_to_group")
