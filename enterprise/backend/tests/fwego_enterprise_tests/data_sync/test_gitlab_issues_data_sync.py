...
from fwego_enterprise.data_sync.models import GitLabIssuesDataSync
...
SINGLE_ISSUE = {
    ...
    "milestone": {
        ...
        "expired": False,
        "web_url": "https://github.com/digitranslab/fwego/-/milestones/1",
    },
    "assignees": [
        {
            "id": 1,
    ...
    "issue_type": "issue",
    "web_url": "https://github.com/digitranslab/fwego/-/issues/1",
    "time_stats": {
        "time_estimate": 0,
        "total_time_spent": 0,
    ...
    "references": {"short": "#1", "relative": "#1", "full": "digitranslab/fwego#1"},
    "severity": "UNKNOWN",
    "moved_to_id": None,
    "imported": False,
    "imported_from": "none",
...
def test_sync_data_sync_table(enterprise_data_fixture):
    ...
    assert (
        ...
        == "https://github.com/digitranslab/fwego/-/issues/1"
    )
