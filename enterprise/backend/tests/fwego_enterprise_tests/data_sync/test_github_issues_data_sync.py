...
from fwego_premium.license.models import License
from rest_framework.status import HTTP_200_OK, HTTP_402_PAYMENT_REQUIRED

from fwego.contrib.database.data_sync.handler import DataSyncHandler
from fwego.contrib.database.fields.models import NumberField
from fwego.core.db import specific_iterator
from fwego_enterprise.data_sync.models import GitHubIssuesDataSync

SINGLE_ISSUE = {
    "url": "https://api.github.com/repos/fwego_owner/fwego_repo/issues/1",
    "repository_url": "https://api.github.com/repos/fwego_owner/fwego_repo",
    "labels_url": "https://api.github.com/repos/fwego_owner/fwego_repo/issues/1/labels{/name}",
    "comments_url": "https://api.github.com/repos/fwego_owner/fwego_repo/issues/1/comments",
    "events_url": "https://api.github.com/repos/fwego_owner/fwego_repo/issues/1/events",
    "html_url": "https://api.github.com/repos/fwego_owner/fwego_repo/issues/1",
    "id": 1,
    ...
    "labels": [
        {
            ...
            "url": "https://api.github.com/repos/fwego_owner/fwego_repo/labels/bug",
            "name": "bug",
            "color": "f29513",
            "default": False,
            "description": "A bug",
    ...
    "milestone": {
        "url": "https://api.github.com/repos/fwego_owner/fwego_repo/milestones/1",
        "html_url": "https://github.com/fwego_owner/fwego_repo/milestones/v1.0",
        "labels_url": "https://api.github.com/repos/fwego_owner/fwego_repo/milestones/1/labels",
        "id": 1,
    ...
    "reactions": {
        "url": "https://api.github.com/repos/fwego_owner/fwego_repo/issues/1/reactions",
        "total_count": 0,
        "+1": 0,
        "-1": 0,
        "laugh": 0,
    ...
    "timeline_url": "https://api.github.com/repos/fwego_owner/fwego_repo/issues/1/timeline",
...
def test_create_data_sync_table(enterprise_data_fixture):
    ...
    data_sync = handler.create_data_sync_table(
        ...
        github_issues_owner="fwego_owner",
        github_issues_repo="fwego_repo",
        github_issues_api_token="test",
    )

    assert isinstance(data_sync, GitHubIssuesDataSync)
    assert data_sync.github_issues_owner == "fwego_owner"
    assert data_sync.github_issues_repo == "fwego_repo"
...
def test_sync_data_sync_table(enterprise_data_fixture):
    responses.add(
        responses.GET,
        "https://api.github.com/repos/fwego_owner/fwego_repo/issues?page=1&per_page=50&state=all",
        status=200,
        json=SINGLE_ISSUE_RESPONSE,
    )
    responses.add(
        responses.GET,
        "https://api.github.com/repos/fwego_owner/fwego_repo/issues?page=2&per_page=50&state=all",
        status=200,
    ...
    assert (
        ...
        == "https://github.com/fwego_owner/fwego_repo/issues/1"
    )
...
def test_create_data_sync_table_pagination(enterprise_data_fixture):
    ...
    responses.add(
        responses.GET,
        "https://api.github.com/repos/fwego_owner/fwego_repo/issues?page=3&per_page=50&state=all",
        status=200,
        json=NO_ISSUES_RESPONSE,
    )
...
def test_create_data_sync_table_invalid_auth(enterprise_data_fixture):
    responses.add(
        responses.GET,
        "https://api.github.com/repos/fwego_owner/fwego_repo/issues",
        status=401,
        json={
