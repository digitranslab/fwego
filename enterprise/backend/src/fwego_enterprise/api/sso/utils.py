...
# please keep this in sync with fwego_enterprise/locales/en.json
...
def get_valid_frontend_url(
    ...
    :param default_frontend_urls: The first one is the default fallback frontend URL.
      Fwego one is used if None. Others are also allowed as valid URLs.
...
def get_frontend_default_redirect_url() -> str:
    ...
    :return: The absolute url to the Fwego dashboard.
    """
...
def get_frontend_login_error_url() -> str:
    ...
    :return: The absolute url to the Fwego login error page.
    """
...
def get_frontend_login_saml_url() -> str:
    ...
    :return: The absolute url to the Fwego SAML login page.
    """
