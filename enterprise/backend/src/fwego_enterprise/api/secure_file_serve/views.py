...
from fwego.core.user.utils import UserSessionPayload
from fwego_enterprise.features import SECURE_FILE_SERVE
...
from fwego_enterprise.secure_file_serve.handler import SecureFileServeHandler
...
class DownloadView(APIView):
    ...
    def authentication_classes(self):
        if (
            settings.FWEGO_SERVE_FILES_THROUGH_BACKEND_PERMISSION
