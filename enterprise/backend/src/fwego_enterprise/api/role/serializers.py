...
from fwego.api.serializers import NaturalKeyRelatedField
from fwego.core.registries import object_scope_type_registry, subject_type_registry
from fwego_enterprise.exceptions import RoleNotExist, ScopeNotExist, SubjectNotExist
from fwego_enterprise.models import Role, RoleAssignment, Team
