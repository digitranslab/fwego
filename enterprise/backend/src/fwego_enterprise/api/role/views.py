...
from fwego.core.registries import object_scope_type_registry
from fwego.core.utils import unique_dicts_in_list
...
from fwego_enterprise.exceptions import (
    RoleNotExist,
    ScopeNotExist,
    SubjectNotExist,
    SubjectUnsupported,
)
from fwego_enterprise.features import RBAC
from fwego_enterprise.role.actions import BatchAssignRoleActionType
from fwego_enterprise.role.constants import ROLE_ASSIGNABLE_OBJECT_MAP
from fwego_enterprise.role.handler import RoleAssignmentHandler
from fwego_enterprise.role.types import NewRoleAssignment
