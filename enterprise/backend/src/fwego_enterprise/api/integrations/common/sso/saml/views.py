...
from fwego.api.user_sources.errors import ERROR_USER_SOURCE_DOES_NOT_EXIST
from fwego.api.utils import validate_data
from fwego.core.user.exceptions import DeactivatedUserException
...
from fwego_enterprise.api.integrations.common.sso.saml.serializers import (
    CommonSAMLResponseSerializer,
    CommonSsoLoginRequestSerializer,
)
from fwego_enterprise.api.sso.serializers import BaseSsoLoginRequestSerializer
...
from fwego_enterprise.integrations.common.sso.saml.handler import (
...
class SamlAppAuthProviderFwegoInitiatedSingleSignOn(APIView):
    permission_classes = (AllowAny,)
