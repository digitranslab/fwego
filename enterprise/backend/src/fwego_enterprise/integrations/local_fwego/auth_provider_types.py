...
from fwego.contrib.database.fields.field_types import PasswordFieldType
from fwego.contrib.database.fields.handler import FieldHandler
from fwego.core.app_auth_providers.auth_provider_types import AppAuthProviderType
from fwego.core.app_auth_providers.types import AppAuthProviderTypeDict
from fwego.core.auth_provider.types import AuthProviderModelSubClass
from fwego.core.user_sources.types import UserSourceSubClass
...
class LocalFwegoPasswordAppAuthProviderType(AppAuthProviderType):
    type = "local_fwego_password"
    model_class = LocalFwegoPasswordAppAuthProvider
    compatible_user_source_types = [LocalFwegoUserSourceType.type]
    ...
    def can_create_new_providers(
        ...
        return not LocalFwegoPasswordAppAuthProvider.objects.filter(
    ...
    def prepare_values(
        ...
        values: Dict[str, Any],
        user: AbstractUser,
        instance: Optional[LocalFwegoPasswordAppAuthProvider] = None,
    ) -> Dict[str, Any]:
    ...
    def after_user_source_update(
        self,
        user: "AbstractUser",
        instance: LocalFwegoPasswordAppAuthProvider,
        user_source,
    ):
        """
