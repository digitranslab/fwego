...
from fwego_enterprise.api.sso.saml.validators import validate_unique_saml_domain
from fwego_enterprise.integrations.local_fwego.user_source_types import (
    LocalFwegoUserSourceType,
)
from fwego_enterprise.sso.saml.auth_provider_types import SamlAuthProviderTypeMixin
...
class SamlAppAuthProviderType(SamlAuthProviderTypeMixin, AppAuthProviderType):
    ...
    def get_api_urls(self):
        from fwego_enterprise.api.integrations.common.sso.saml import urls
