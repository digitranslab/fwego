...
class FwegoEnterpriseConfig(AppConfig):
    name = "fwego_enterprise"

    def ready(self):
        from fwego.core.jobs.registries import job_type_registry
        from fwego_enterprise.audit_log.job_types import AuditLogExportJobType
        ...
        from fwego.api.user.registries import member_data_registry
        from fwego.core.action.registries import (
        ...
        from fwego.core.trash.registries import trash_item_type_registry
        from fwego_enterprise.api.member_data_types import (
            EnterpriseMemberTeamsDataType,
        )
        from fwego_enterprise.role.actions import BatchAssignRoleActionType
        from fwego_enterprise.scopes import TeamsActionScopeType
        from fwego_enterprise.teams.actions import (
        ...
        from fwego_enterprise.teams.object_scopes import (
            TeamObjectScopeType,
        ...
        from fwego_enterprise.trash_types import TeamTrashableItemType
        ...
        from fwego.core.registries import subject_type_registry
        ...
        from fwego_premium.license.registries import license_type_registry

        from fwego_enterprise.license_types import (
        ...
        from fwego.core.registries import auth_provider_type_registry
        from fwego_enterprise.sso.oauth2.auth_provider_types import (
        ...
        from fwego_enterprise.sso.saml.auth_provider_types import SamlAuthProviderType
        ...
        from fwego.core.registries import serialization_processor_registry
        from fwego_enterprise.structure_types import (
        ...
        user_source_type_registry.register(LocalFwegoUserSourceType())

        from fwego.core.app_auth_providers.registries import (
            app_auth_provider_type_registry,
        )
        from fwego_enterprise.integrations.local_fwego.auth_provider_types import (
        ...
        from fwego_enterprise.integrations.common.sso.saml.app_auth_provider_types import (
        ...
        from fwego_enterprise.builder.elements.element_types import (
            AuthFormElementType,
        )

        element_type_registry.register(AuthFormElementType())

        from fwego.contrib.database.data_sync.registries import (
            data_sync_type_registry,
        )
        from fwego_enterprise.data_sync.data_sync_types import (
        ...
        data_sync_type_registry.register(LocalFwegoTableDataSyncType())
        ...
        from fwego_enterprise.teams.receivers import (
            connect_to_post_delete_signals_to_cascade_deletion_to_team_subjects,
        )

        connect_to_post_delete_signals_to_cascade_deletion_to_team_subjects()

        from fwego_enterprise.role.receivers import (
        ...
        import fwego_enterprise.audit_log.signals  # noqa: F
        import fwego_enterprise.ws.signals  # noqa: F


def sync_default_roles_after_migrate(sender, **kwargs):
    from fwego.core.db import LockedAtomicTransaction
    ...
    if apps is not None:
        try:
            ...
            Role = apps.get_model("fwego_enterprise", "Role")
        except LookupError:
