...
from fwego.core.auth_provider.types import UserInfo
from fwego_enterprise.api.sso.oauth2.errors import ERROR_INVALID_PROVIDER_URL
from fwego_enterprise.sso.exceptions import AuthFlowError, InvalidProviderUrl
...
class OAuth2AuthProviderMixin:
    ...
    def get_api_urls(self):
        ...
        from fwego_enterprise.api.sso.oauth2 import urls
