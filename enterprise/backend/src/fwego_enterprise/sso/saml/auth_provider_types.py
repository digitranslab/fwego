...
from fwego.api.utils import ExceptionMappingType
from fwego.core.auth_provider.auth_provider_types import AuthProviderType
from fwego.core.auth_provider.validators import validate_domain
from fwego_enterprise.api.sso.saml.errors import (
    ERROR_SAML_PROVIDER_FOR_DOMAIN_ALREADY_EXISTS,
)
from fwego_enterprise.api.sso.saml.validators import (
...
from fwego_enterprise.sso.saml.exceptions import SamlProviderForDomainAlreadyExists
...
class SamlAuthProviderType(SamlAuthProviderTypeMixin, AuthProviderType):
    ...
    def get_api_urls(self):
        from fwego_enterprise.api.sso.saml import urls
