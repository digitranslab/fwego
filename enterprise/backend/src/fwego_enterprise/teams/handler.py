...
from fwego_enterprise.models import Role, RoleAssignment, Team, TeamSubject
from fwego_enterprise.role.handler import RoleAssignmentHandler
from fwego_enterprise.signals import (
    team_created,
    team_deleted,
    ...
    def get_teams_sample_queryset(self, subject_sample_size: int = 10) -> QuerySet:
        ...
        subject_sample_sql = """
            SELECT COALESCE(json_agg(sub), '[]') FROM (
                ...
                FROM fwego_enterprise_teamsubject sub
                ...
                WHERE sub.team_id = fwego_enterprise_team.id
