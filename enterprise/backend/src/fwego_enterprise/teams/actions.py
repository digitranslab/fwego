...
from fwego_enterprise.models import Team, TeamSubject
...
class CreateTeamActionType(UndoableActionType):
    ...
    def do(
        ...
        fwego_enterprise.teams.handler.TeamHandler.create_team
...
class UpdateTeamActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego_enterprise.teams.handler.TeamHandler.update_team
            for further details.
...
class DeleteTeamActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, team: Team) -> None:
        ...
        fwego_enterprise.teams.handler.TeamHandler.delete_team for further details.
...
class CreateTeamSubjectActionType(UndoableActionType):
    ...
    def do(
        ...
        fwego_enterprise.teams.handler.TeamHandler.create_subject
...
class DeleteTeamSubjectActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, subject: TeamSubject) -> None:
        ...
        fwego_enterprise.teams.handler.TeamHandler.delete_team_subject for
