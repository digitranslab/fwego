...
from fwego.core.utils import ChildProgressBuilder, get_value_at_path
from fwego_enterprise.data_sync.models import HubSpotContactsDataSync
...
class HubspotNumberProperty(BaseHubspotProperty):
    ...
    def is_equal(self, fwego_row_value, data_sync_row_value) -> bool:
        data_sync_row_value = (
