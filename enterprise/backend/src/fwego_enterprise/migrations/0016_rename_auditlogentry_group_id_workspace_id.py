...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("fwego_enterprise", "0015_alter_team_workspace"),
    ]

    forwards = """
        ALTER TABLE fwego_enterprise_auditlogentry
        RENAME COLUMN group_id TO workspace_id;
        ALTER TABLE fwego_enterprise_auditlogentry
        RENAME CONSTRAINT fwego_enterprise_auditlogentry_group_id_check TO
        fwego_enterprise_auditlogentry_workspace_id_check;
    """
    ...
    backwards = """
        ...
        ALTER TABLE fwego_enterprise_auditlogentry
        RENAME CONSTRAINT fwego_enterprise_auditlogentry_workspace_id_check TO
        fwego_enterprise_auditlogentry_group_id_check;
    """
        ...
        migrations.SeparateDatabaseAndState(
            ...
            state_operations=[
                migrations.RemoveIndex(
                    ...
                    name="fwego_ent_action__8db5d6_idx",
                ),
                ...
                migrations.AddIndex(
                    ...
                    index=models.Index(
                        ...
                        name="fwego_ent_action__ca13aa_idx",
                        # Note: the index name in PG will
                        # be `fwego_ent_action__8db5d6_idx`
                    ),
                ),
            ],
        ),
