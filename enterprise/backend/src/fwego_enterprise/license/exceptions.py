...
class SingleSignOnFeatureNotAvailableError(APIException):
    """
    Raised when the single-sign-on feature is not available for this Fwego instance.
    """
        ...
        super().__init__(
            {
                ...
                "detail": "The single-sign-on feature is not enabled for this Fwego instance.",
            },
