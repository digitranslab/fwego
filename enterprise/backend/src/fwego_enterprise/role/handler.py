...
from fwego.core.object_scopes import CoreObjectScopeType
...
from fwego.core.types import PermissionCheck, ScopeObject, Subject
...
from fwego_enterprise.models import RoleAssignment
