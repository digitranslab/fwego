<template>
  <form>
    <FormGroup
      :label="$t('localFwegoPasswordAppAuthProviderForm.passwordFieldLabel')"
      small-label
      horizontal
      horizontal-variable
      required
    >
      <Dropdown
        ...
        :placeholder="
          $t('localFwegoPasswordAppAuthProviderForm.passwordFieldLabel')
        "
      >
        <DropdownItem
        ...
        />
        <template #emptyState>
          {{ $t('localFwegoPasswordAppAuthProviderForm.noFields') }}
        </template>
      </Dropdown>
    </FormGroup>
  </form>
...
<script>
import authProviderForm from '@fwego/modules/core/mixins/authProviderForm'
