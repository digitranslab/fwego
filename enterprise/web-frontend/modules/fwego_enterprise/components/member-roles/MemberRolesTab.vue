...
import MemberRolesMembersList from '@fwego_enterprise/components/member-roles/MemberRolesMembersList'
import RoleAssignmentModal from '@fwego_enterprise/components/member-roles/RoleAssignmentModal'
...
export default {
  ...
  computed: {
    ...
    teamRoleAssignments() {
      return this.roleAssignments.filter(
        (roleAssignment) =>
          roleAssignment.subject_type === 'fwego_enterprise.Team'
      )
    },
    workspaceUsers() {
