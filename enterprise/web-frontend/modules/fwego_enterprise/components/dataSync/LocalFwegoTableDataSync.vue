<template>
  <form @submit.prevent="submit">
    <div class="margin-top-3 margin-bottom-3">
      <Presentation
        :title="userName"
        :subtitle="$t('localFwegoTableDataSync.authorizing')"
    ...
    <div class="row margin-bottom-3">
      <div class="col col-4">
        <FormGroup
          small-label
          :label="$t('localFwegoTableDataSync.workspace')"
          required
        >
          <Dropdown
      ...
      <div class="col col-4">
        <FormGroup
          small-label
          :label="$t('localFwegoTableDataSync.database')"
          required
        >
          <Dropdown
      ...
      <div class="col col-4">
        <FormGroup
          ...
          small-label
          :label="$t('localFwegoTableDataSync.table')"
          required
        >
          <Dropdown
