...
<script>
import CreateTeamModal from '@fwego_enterprise/components/teams/CreateTeamModal'
import UpdateTeamModal from '@fwego_enterprise/components/teams/UpdateTeamModal'
import TeamRoleField from '@fwego_enterprise/components/crudTable/fields/TeamRoleField'
import SubjectSampleField from '@fwego_enterprise/components/crudTable/fields/SubjectSampleField'
import CrudTable from '@fwego/modules/core/components/crudTable/CrudTable'
import TeamService from '@fwego_enterprise/services/team'
...
import EditTeamContext from '@fwego_enterprise/components/teams/EditTeamContext'
