<template>
  <div class="auth-provider-admin__item">
    ...
    <div class="auth-provider-admin__item-menu">
      ...
      >
        <i
          class="fwego-icon-more-vertical auth-provider-admin__item-menu-options"
        ></i>
      </a>
...
import EditAuthProviderMenuContext from '@fwego_enterprise/components/admin/contexts/EditAuthProviderMenuContext.vue'
import UpdateSettingsAuthProviderModal from '@fwego_enterprise/components/admin/modals/UpdateSettingsAuthProviderModal.vue'
import DeleteAuthProviderModal from '@fwego_enterprise/components/admin/modals/DeleteAuthProviderModal.vue'
import AuthProviderIcon from '@fwego_enterprise/components/AuthProviderIcon.vue'
import authProviderItemMixin from '@fwego_enterprise/mixins/authProviderItemMixin'
