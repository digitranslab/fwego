import { AuthProviderType } from '@fwego/modules/core/authProviderTypes'

import SamlLoginAction from '@fwego_enterprise/components/admin/login/SamlLoginAction'
import AuthProviderItem from '@fwego_enterprise/components/admin/AuthProviderItem'
import SamlSettingsForm from '@fwego_enterprise/components/admin/forms/SamlSettingsForm'
import OAuth2SettingsForm from '@fwego_enterprise/components/admin/forms/OAuth2SettingsForm.vue'
import GitLabSettingsForm from '@fwego_enterprise/components/admin/forms/GitLabSettingsForm.vue'
import OpenIdConnectSettingsForm from '@fwego_enterprise/components/admin/forms/OpenIdConnectSettingsForm.vue'
import LoginButton from '@fwego_enterprise/components/admin/login/LoginButton.vue'

import PasswordAuthIcon from '@fwego/modules/core/assets/images/providers/Key.svg'
import SAMLIcon from '@fwego_enterprise/assets/images/providers/LockKey.svg'
import GoogleIcon from '@fwego_enterprise/assets/images/providers/Google.svg'
import FacebookIcon from '@fwego_enterprise/assets/images/providers/Facebook.svg'
import GitHubIcon from '@fwego_enterprise/assets/images/providers/GitHub.svg'
import GitLabIcon from '@fwego_enterprise/assets/images/providers/GitLab.svg'
import OpenIdIcon from '@fwego_enterprise/assets/images/providers/OpenID.svg'
import VerifiedProviderIcon from '@fwego_enterprise/assets/images/providers/VerifiedProviderIcon.svg'
