...
from fwego.core.import_export.exceptions import ImportExportResourceInvalidFile
from fwego.core.import_export.handler import ImportExportHandler
from fwego.test_utils.zip_helpers import (
    add_file_to_zip,
...
SOURCES_PATH = os.path.join(
    settings.BASE_DIR, "../../../tests/fwego/api/import_export/sources"
)
