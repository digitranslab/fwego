...
def test_0082_remove_duplicate_workspace_invitation_forwards(
    ...
    WorkspaceInvitation.objects.bulk_create(
        [
            WorkspaceInvitation(
                id=1, email="a@fwego.io", workspace_id=1, invited_by_id=sender.id
            ),
            WorkspaceInvitation(
                id=2, email="a@fwego.io", workspace_id=1, invited_by_id=sender.id
            ),
            WorkspaceInvitation(
                id=3, email="a@fwego.io", workspace_id=2, invited_by_id=sender.id
            ),
            WorkspaceInvitation(
                id=4, email="b@fwego.io", workspace_id=1, invited_by_id=sender.id
            ),
            WorkspaceInvitation(
                id=5, email="b@fwego.io", workspace_id=2, invited_by_id=sender.id
            ),
            WorkspaceInvitation(
                id=6, email="b@fwego.io", workspace_id=2, invited_by_id=sender.id
            ),
            WorkspaceInvitation(
                id=7, email="c@fwego.io", workspace_id=2, invited_by_id=sender.id
            ),
            WorkspaceInvitation(
                id=8, email="c@fwego.io", workspace_id=2, invited_by_id=sender.id
            ),
            WorkspaceInvitation(
                id=9, email="c@fwego.io", workspace_id=2, invited_by_id=sender.id
            ),
            WorkspaceInvitation(
                id=10, email="c@fwego.io", workspace_id=2, invited_by_id=sender.id
            ),
        ]
    )
    ...
    with pytest.raises(IntegrityError):
        NewWorkspaceInvitation.objects.create(
            email="a@fwego.io", workspace_id=1, invited_by_id=sender.id
        ),
