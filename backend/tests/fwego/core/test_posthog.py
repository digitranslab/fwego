...
from fwego.core.posthog import capture_event_action_done, capture_user_event
...
@patch("fwego.core.posthog.posthog")
...
@pytest.mark.django_db
@patch("fwego.core.posthog.capture_user_event")
