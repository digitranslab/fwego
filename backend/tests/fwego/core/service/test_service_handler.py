...
def test_get_services(data_fixture):
    ...
    service1 = data_fixture.create_local_fwego_get_row_service(
        integration=integration
    )
    service2 = data_fixture.create_local_fwego_get_row_service(
        integration=integration
    )
    service3 = data_fixture.create_local_fwego_get_row_service(
        integration=integration
    )
    ...
    assert isinstance(services[0], LocalFwegoGetRow)
...
@pytest.mark.django_db
def test_dispatch_local_fwego_get_row_service_missing_integration(data_fixture):
    service = data_fixture.create_local_fwego_get_row_service(integration=None)
