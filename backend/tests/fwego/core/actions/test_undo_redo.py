...
from fwego.api.sessions import set_untrusted_client_session_id
from fwego.contrib.database.fields.actions import UpdateFieldActionType
...
from fwego.core.action.scopes import RootActionScopeType, WorkspaceActionScopeType
...
from fwego.core.models import WORKSPACE_USER_PERMISSION_ADMIN, Application, Workspace
...
def test_when_redo_fails_the_action_is_rolled_back(
    ...
    with patch(
        "fwego.core.signals.workspace_deleted.send"
