...
from fwego.core.integrations.exceptions import (
...
from fwego.core.integrations.service import IntegrationService
...
@patch("fwego.core.integrations.service.integration_created")
...
def test_get_unique_orders_before_integration_triggering_full_application_order_reset(
    ...
    user = data_fixture.create_user()
    application = data_fixture.create_builder_application(user=user)
    integration_1 = data_fixture.create_local_fwego_integration(
        application=application, order="1.00000000000000000000"
    )
    integration_2 = data_fixture.create_local_fwego_integration(
        application=application, order="1.00000000000000001000"
    )
    integration_3 = data_fixture.create_local_fwego_integration(
        application=application, order="2.99999999999999999999"
    )
    integration_4 = data_fixture.create_local_fwego_integration(
...
@pytest.mark.django_db
@patch("fwego.core.integrations.service.integration_orders_recalculated")
def test_recalculate_full_order(integration_orders_recalculated_mock, data_fixture):
    user = data_fixture.create_user()
    application = data_fixture.create_builder_application(user=user)
    data_fixture.create_local_fwego_integration(
...
@pytest.mark.django_db
@patch("fwego.core.integrations.service.integration_deleted")
...
@pytest.mark.django_db
@patch("fwego.core.integrations.service.integration_updated")
