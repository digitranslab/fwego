...
from fwego.core.integrations.exceptions import IntegrationDoesNotExist
from fwego.core.integrations.handler import IntegrationHandler
from fwego.core.integrations.models import Integration
from fwego.core.integrations.registries import (
    IntegrationType,
...
def test_create_integration_bad_application(data_fixture):
    ...
    integration_type = integration_type_registry.get("local_fwego")
...
def test_get_integrations(data_fixture):
    ...
    integration1 = data_fixture.create_local_fwego_integration(application=builder)
    integration2 = data_fixture.create_local_fwego_integration(application=builder)
    integration3 = data_fixture.create_local_fwego_integration(application=builder)
    ...
    assert isinstance(integrations[0], LocalFwegoIntegration)
...
def test_move_integration_before_fails(data_fixture):
    ...
    integration3 = data_fixture.create_local_fwego_integration(
...
def test_recalculate_full_orders(data_fixture):
    ...
    integration4 = data_fixture.create_local_fwego_integration(
        application=builder, order="2.10000000000000000000"
    )
    integration5 = data_fixture.create_local_fwego_integration(
        application=builder, order="3.00000000000000000000"
    )
    integration6 = data_fixture.create_local_fwego_integration(
        application=builder, order="1.00000000000000000001"
    )
    integration7 = data_fixture.create_local_fwego_integration(
        application=builder, order="3.99999999999999999999"
    )
    integration8 = data_fixture.create_local_fwego_integration(
        application=builder, order="4.00000000000000000001"
    )

    builder2 = data_fixture.create_builder_application()

    integrationA = data_fixture.create_local_fwego_integration(
        application=builder2, order="1.99999999999999999999"
    )
    integrationB = data_fixture.create_local_fwego_integration(
