...
from fwego.core.app_auth_providers.exceptions import IncompatibleUserSourceType
...
@patch("fwego.core.user_sources.service.user_source_created")
...
@pytest.mark.django_db
@patch("fwego.core.user_sources.service.user_source_orders_recalculated")
...
@pytest.mark.django_db
@patch("fwego.core.user_sources.service.user_source_deleted")
...
@pytest.mark.django_db
@patch("fwego.core.user_sources.service.user_source_updated")
