...
@patch(
    "fwego.core.snapshots.job_types.CreateSnapshotJobType.transaction_atomic_context",
    new=contextlib.nullcontext,
)
@patch("fwego.core.action.signals.action_done.send")
...
@pytest.mark.django_db
@patch(
    "fwego.core.snapshots.job_types.RestoreSnapshotJobType.transaction_atomic_context",
    new=contextlib.nullcontext,
)
@patch("fwego.core.action.signals.action_done.send")
