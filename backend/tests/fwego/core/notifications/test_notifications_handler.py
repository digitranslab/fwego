...
from fwego.api.notifications.serializers import NotificationRecipientSerializer
from fwego.core.models import UserProfile, WorkspaceUser
from fwego.core.notifications.exceptions import NotificationDoesNotExist
from fwego.core.notifications.handler import (
    NotificationHandler,
    UserNotificationsGrouper,
)
from fwego.core.notifications.models import Notification, NotificationRecipient
...
@pytest.mark.django_db
@patch("fwego.core.notifications.tasks.send_queued_notifications_to_users.delay")
...
def test_not_all_notification_types_are_included_in_the_email_notification_summary(
    ...
    with custom_notification_types_registered() as (
        ...
        assert (
            ...
            == "You have 1 new notification - Fwego"
        )
...
def test_email_notifications_are_included_up_to_email_limit(
    ...
    with custom_notification_types_registered() as (TestNotification, _):
        ...
        assert (
            user_1_summary_email.get_subject()
            == f"You have {limit + 1} new notifications - Fwego"
        )
