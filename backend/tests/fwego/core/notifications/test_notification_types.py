...
@pytest.mark.django_db
@patch("fwego.core.notifications.signals.notification_created.send")
def test_fwego_version_upgrade_is_sent_as_broadcast_notification(
    mocked_notification_created, api_client, data_fixture
):
    ...
    with freeze_time("2023-07-06 12:00"):
        FwegoVersionUpgradeNotificationType.create_version_upgrade_broadcast_notification(
        ...
        "results": [
            {
                "id": AnyInt(),
                "created_on": "2023-07-06T12:00:00Z",
                "type": FwegoVersionUpgradeNotificationType.type,
                "data": {
                    "version": "1.19",
