...
base_module = "fwego.core.generative_ai.generative_ai_model_types"
...
def test_openai_max_file_size(settings):
    ...
    settings.FWEGO_OPENAI_UPLOADED_FILE_SIZE_LIMIT_MB = 1000
    assert ai_model_type.get_max_file_size() == 512

    settings.FWEGO_OPENAI_UPLOADED_FILE_SIZE_LIMIT_MB = 100
