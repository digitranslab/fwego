...
@pytest.mark.django_db
@patch("fwego.api.health.views.get_celery_queue_size")
...
@pytest.mark.django_db
@override_settings(FWEGO_MAX_HEALTHY_CELERY_QUEUE_SIZE=10)
@patch("fwego.api.health.views.get_celery_queue_size")
...
@pytest.mark.django_db
@override_settings(FWEGO_MAX_HEALTHY_CELERY_QUEUE_SIZE=10)
@patch("fwego.api.health.views.get_celery_queue_size", kwargs={"queue": "celery"})
