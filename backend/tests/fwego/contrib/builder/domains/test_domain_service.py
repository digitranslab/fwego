...
from fwego.contrib.builder.domains.domain_types import CustomDomainType
from fwego.contrib.builder.domains.exceptions import DomainNotInBuilder
from fwego.contrib.builder.domains.models import Domain
from fwego.contrib.builder.domains.service import DomainService
from fwego.core.exceptions import PermissionException, UserNotInWorkspace
from fwego.core.utils import Progress


@patch("fwego.contrib.builder.domains.service.domain_created")
...
@patch("fwego.contrib.builder.domains.service.domain_deleted")
@pytest.mark.django_db
...
@patch("fwego.contrib.builder.domains.service.domain_updated")
@pytest.mark.django_db
...
@patch("fwego.contrib.builder.domains.service.domains_reordered")
@pytest.mark.django_db
