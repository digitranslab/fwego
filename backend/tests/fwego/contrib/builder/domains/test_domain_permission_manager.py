...
from fwego.contrib.builder.domains.permission_manager import (
    AllowPublicBuilderManagerType,
)
from fwego.contrib.builder.elements.operations import ListElementsPageOperationType
from fwego.contrib.builder.pages.operations import UpdatePageOperationType
...
def test_allow_public_builder_manager_type(data_fixture):
    ...
    public_data_source = data_fixture.create_builder_local_fwego_get_row_data_source(
        page=public_page
    )
