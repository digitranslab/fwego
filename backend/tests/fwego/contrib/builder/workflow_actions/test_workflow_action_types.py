...
from fwego.core.workflow_actions.registries import WorkflowActionType
...
@patch(
    "fwego.contrib.builder.workflow_actions.workflow_action_types.BuilderWorkflowActionType.deserialize_property"
)
