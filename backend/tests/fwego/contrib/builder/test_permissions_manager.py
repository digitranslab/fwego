...
def test_allow_if_template_permission_manager(data_fixture):
    ...
    workflow_action_1 = data_fixture.create_local_fwego_update_row_workflow_action(
    ...
    workflow_action_2 = data_fixture.create_local_fwego_update_row_workflow_action(
