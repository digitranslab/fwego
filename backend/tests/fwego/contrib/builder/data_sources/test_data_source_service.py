...
from fwego.contrib.builder.data_sources.exceptions import (
...
from fwego.contrib.builder.pages.exceptions import PageNotInBuilder
from fwego.contrib.database.views.view_filters import EqualViewFilterType
from fwego.core.exceptions import PermissionException
from fwego.core.services.exceptions import InvalidServiceTypeDispatchSource
from fwego.core.services.models import Service
from fwego.core.services.registries import DispatchTypes, service_type_registry
from fwego.test_utils.helpers import AnyStr


@pytest.mark.django_db
@patch("fwego.contrib.builder.data_sources.service.data_source_created")
...
def test_create_data_source_with_service_type_for_different_dispatch_type(
    ...
    service_type = service_type_registry.get("local_fwego_upsert_row")
...
@pytest.mark.django_db
@patch("fwego.contrib.builder.data_sources.service.data_source_orders_recalculated")
...
@pytest.mark.django_db
@patch("fwego.contrib.builder.data_sources.service.data_source_deleted")
...
@pytest.mark.django_db
@patch("fwego.contrib.builder.data_sources.service.data_source_updated")
...
def test_update_data_source_with_service_type_for_different_dispatch_type(
    ...
    new_service_type = service_type_registry.get("local_fwego_upsert_row")
...
def test_dispatch_data_sources_excludes_unused_get_row_data_sources(
    ...
    with patch(
        "fwego.contrib.builder.data_sources.service.BuilderDispatchContext.public_formula_fields",
