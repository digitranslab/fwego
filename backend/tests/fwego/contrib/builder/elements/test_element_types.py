...
from fwego.contrib.builder.elements.element_types import (
    ButtonElementType,
    CheckboxElementType,
    ChoiceElementType,
    ColumnElementType,
...
def test_collection_element_type_prepare_value_for_db(
    ...
    multiple_rows = data_fixture.create_builder_local_fwego_list_rows_data_source(
        user=user,
        page=page,
    )
    single_row = data_fixture.create_builder_local_fwego_get_row_data_source(
        user=user, page=page
    )
