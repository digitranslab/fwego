...
from fwego.contrib.builder.elements.receivers import (
    page_deleted_update_link_collection_fields,
)
from fwego.contrib.builder.elements.registries import collection_field_type_registry
from fwego.contrib.builder.pages.service import PageService
from fwego.contrib.builder.pages.signals import page_deleted
