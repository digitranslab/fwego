...
from fwego.core.jobs.cache import job_progress_key
from fwego.core.jobs.constants import JOB_FAILED, JOB_FINISHED
...
@responses.activate
@patch(
    "fwego.contrib.database.airtable.handler"
...
@responses.activate
@patch(
    "fwego.contrib.database.airtable.handler.AirtableHandler"
