...
from fwego.contrib.database.rows.actions import UpdateRowsActionType
            ...
            [
                {
                    ...
                    f"field_{url_field.id}": "https://fwego.io",
        ...
        "results": [
            {
                ...
                "before": {
                    ...
                    f"field_{url_field.id}": "http://fwego.io",
