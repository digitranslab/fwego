...
def test_escape_query():
    ...
    assert SearchHandler.escape_query("https://fwego.io") == "https fwego io"
...
@pytest.mark.django_db
@patch("fwego.contrib.database.search.handler.SearchHandler.update_tsvector_columns")
...
@pytest.mark.django_db
@patch("fwego.contrib.database.search.handler.SearchHandler.update_tsvector_columns")
@patch("fwego.contrib.database.search.handler.cache")
