...
from fwego.contrib.database.fields.models import FormulaField, LookupField
from fwego.contrib.database.fields.registries import field_type_registry
from fwego.contrib.database.fields.utils import DeferredForeignKeyUpdater
...
def test_import_export_lookup_field_when_through_field_trashed(
    ...
    assert lookup_field_imported.formula_type == FwegoFormulaInvalidType.type
...
def test_import_export_tables_with_lookup_fields(
    ...
    assert imported_lookup_field.formula_type == FwegoFormulaArrayType.type
    assert imported_lookup_field.array_formula_type == FwegoFormulaNumberType.type
...
def test_formula_referencing_lookup_with_same_name_field_in_linked_table_being_renamed(
    ...
    assert table_2_lookup.formula_type == FwegoFormulaInvalidType.type
    assert table_2_formula.formula_type == FwegoFormulaInvalidType.type
