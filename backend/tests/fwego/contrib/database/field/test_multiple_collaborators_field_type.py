...
from fwego.contrib.database.fields.field_types import MultipleCollaboratorsFieldType
from fwego.contrib.database.fields.handler import FieldHandler
from fwego.contrib.database.fields.models import MultipleCollaboratorsField
...
from fwego.core.models import WORKSPACE_USER_PERMISSION_ADMIN, WorkspaceUser
from fwego.core.registries import ImportExportConfig
from fwego.test_utils.helpers import AnyInt
...
def test_get_set_export_serialized_value_multiple_collaborators_field(data_fixture):
    user = data_fixture.create_user(email="user1@fwego.io")
    user_2 = data_fixture.create_user(email="user2@fwego.io")
    user_3 = data_fixture.create_user(email="user3@fwego.io")
...
def test_multiple_collaborators_field_type_sorting(
    ...
    user = data_fixture.create_user(email="user1@fwego.io", first_name="User 1")
    user_2 = data_fixture.create_user(email="user2@fwego.io", first_name="User 2")
    user_3 = data_fixture.create_user(email="user3@fwego.io", first_name="User 3")
    database = data_fixture.create_database_application(user=user, name="Placeholder")
