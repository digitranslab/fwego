...
from fwego.contrib.database.action.scopes import TableActionScopeType
...
from fwego.contrib.database.table.models import RichTextFieldMention
...
from fwego.core.notifications.models import NotificationRecipient
from fwego.core.trash.handler import TrashHandler
from fwego.test_utils.helpers import AnyInt, assert_undo_redo_actions_are_valid


@pytest.mark.django_db(transaction=True)
@patch("fwego.ws.tasks.broadcast_to_users.apply")
...
@pytest.mark.django_db(transaction=True)
@patch("fwego.core.notifications.handler.get_mail_connection")
def test_email_notifications_are_created_correctly_for_collaborators_added(
    ...
    assert user_2_summary_email.get_subject() == "You have 1 new notification - Fwego"
