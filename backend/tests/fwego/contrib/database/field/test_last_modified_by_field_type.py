...
def test_last_modified_by_field_type_sorting(data_fixture):
    user_a = data_fixture.create_user(email="user1@fwego.io", first_name="User a")
    user_b = data_fixture.create_user(email="user2@fwego.io", first_name="User b")
    user_c = data_fixture.create_user(email="user3@fwego.io", first_name="User c")
