...
from fwego.contrib.database.fields.utils.duration import H_M_S
...
from fwego.core.models import TrashEntry, WorkspaceUser
...
@pytest.mark.django_db
@pytest.mark.field_link_row
@patch("fwego.contrib.database.fields.receivers.field_updated.send")
