...
from fwego.contrib.database.formula.migrations.handler import FormulaMigrationHandler
...
@patch(
    "fwego.contrib.database.formula.FormulaHandler.fwego_expression_to_update_django_expression",
)
