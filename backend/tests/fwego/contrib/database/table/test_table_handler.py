...
from fwego.contrib.database.table.handler import TableHandler, TableUsageHandler
from fwego.contrib.database.table.models import Table, TableUsage, TableUsageUpdate
from fwego.contrib.database.views.models import GridView, GridViewFieldOptions, View
...
@pytest.mark.django_db
@patch("fwego.contrib.database.table.signals.tables_reordered.send")
...
@pytest.mark.django_db
@patch("fwego.contrib.database.table.signals.table_deleted.send")
...
@pytest.mark.django_db
@patch("fwego.contrib.database.fields.signals.field_updated.send")
@patch("fwego.contrib.database.table.signals.table_deleted.send")
