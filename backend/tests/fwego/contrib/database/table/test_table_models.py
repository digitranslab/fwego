...
from fwego.contrib.database.search.handler import (
    ALL_SEARCH_MODES,
    SearchHandler,
    SearchModes,
)
...
@pytest.mark.django_db
@patch("fwego.contrib.database.table.models.TableModelQuerySet.pg_search")
@patch("fwego.contrib.database.table.models.TableModelQuerySet.compat_search")
