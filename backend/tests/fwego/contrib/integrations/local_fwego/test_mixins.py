...
from fwego.contrib.database.views.view_filters import ContainsViewFilterType
...
def get_test_service_type(mixin_class):
    class FakeServiceType(mixin_class, LocalFwegoTableServiceType):
        model_class = Mock()
...
def test_local_fwego_table_service_filterable_mixin_get_queryset(
    data_fixture,
):
    service_type = get_test_service_type(LocalFwegoTableServiceFilterableMixin)
    user = data_fixture.create_user()
    table = data_fixture.create_database_table(user=user)
    field = data_fixture.create_text_field(name="Names", table=table)
    table_model = table.get_model()
    service = data_fixture.create_local_fwego_list_rows_service(table=table)
...
def test_local_fwego_table_service_filterable_mixin_import_export(data_fixture):
    user = data_fixture.create_user()
...
@pytest.mark.django_db
def test_local_fwego_table_service_filterable_mixin_get_used_field_names(
    data_fixture,
):
    service_type = get_test_service_type(LocalFwegoTableServiceFilterableMixin)
    user = data_fixture.create_user()
...
@pytest.mark.django_db
def test_local_fwego_table_service_sortable_mixin_get_queryset(
    data_fixture,
):
    service_type = get_test_service_type(LocalFwegoTableServiceSortableMixin)
    user = data_fixture.create_user()
    table = data_fixture.create_database_table(user=user)
    field = data_fixture.create_text_field(name="Names", table=table)
    table_model = table.get_model()
...
@pytest.mark.django_db
def test_local_fwego_table_service_sortable_mixin_get_used_field_names(
    data_fixture,
):
    service_type = get_test_service_type(LocalFwegoTableServiceSortableMixin)
    user = data_fixture.create_user()
...
@pytest.mark.django_db(transaction=True)
def test_local_fwego_table_service_searchable_mixin_get_queryset(
    data_fixture,
):
    service_type = get_test_service_type(LocalFwegoTableServiceSearchableMixin)
...
@pytest.mark.django_db
def test_local_fwego_table_service_searchable_mixin_get_used_field_names(
    data_fixture,
):
    service_type = get_test_service_type(LocalFwegoTableServiceSearchableMixin)
    user = data_fixture.create_user()
