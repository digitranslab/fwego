...
@patch("fwego.ws.signals.broadcast_to_groups")
...
@pytest.mark.django_db(transaction=True)
@patch("fwego.ws.signals.broadcast_to_users")
@pytest.mark.websockets
...
@pytest.mark.django_db(transaction=True)
@patch("fwego.core.notifications.receivers.broadcast_to_users")
@patch("fwego.ws.signals.broadcast_to_users")
@patch("fwego.ws.signals.broadcast_to_group")
@pytest.mark.websockets
...
@pytest.mark.django_db(transaction=True)
@patch("fwego_enterprise.role.receivers.broadcast_to_users")
@patch("fwego.ws.signals.broadcast_to_group")
@pytest.mark.websockets
...
@pytest.mark.django_db(transaction=True)
@patch("fwego.ws.signals.broadcast_application_created")
@pytest.mark.websockets
...
@pytest.mark.django_db(transaction=True)
@patch("fwego.ws.signals.broadcast_to_permitted_users")
@pytest.mark.websockets
...
@pytest.mark.django_db(transaction=True)
@patch("fwego.ws.signals.force_disconnect_users")
@pytest.mark.websockets
