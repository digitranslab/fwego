...
└─ 0.018 update_row_by_id  fwego/contrib/database/rows/handler.py:426
   ├─ 0.015 send  django/dispatch/dispatcher.py:159
   │     [2 frames hidden]  django
   │        0.015 <listcomp>  django/dispatch/dispatcher.py:180
   │        ├─ 0.009 public_before_row_update  fwego/contrib/database/ws/public/rows
   │        │  ├─ 0.004 get_public_views_row_checker  fwego/contrib/database/views/han
   │        │  │  └─ 0.004 __init__  fwego/contrib/database/views/handler.py:985
   │        │  │     ├─ 0.002 apply_filters  fwego/contrib/database/views/handler.py:2
   │        │  │     │  └─ 0.002 apply_to_queryset  fwego/contrib/database/fields/fiel
   ...
   │        │  │              └─ 0.001 get_queryset  fwego/core/managers.py:29
   │        │  │                 └─ 0.001 filter  django/db/models/query.py:935
   │        │  │                       [9 frames hidden]  django
   │        │  ├─ 0.003 _serialize_row  fwego/contrib/database/ws/public/rows/signals
   │        │  │  ├─ 0.002 data  rest_framework/serializers.py:546
   │        │  │  │     [18 frames hidden]  rest_framework, django, copy, <built-in>
   │        │  │  └─ 0.001 get_row_serializer_class  fwego/contrib/database/api/rows/
   │        │  │     └─ 0.001 get_response_serializer_field  fwego/contrib/database/fi
   │        │  └─ 0.002 get_public_views_where_row_is_visible  fwego/contrib/database/
   │        │     └─ 0.002 _check_row_visible  fwego/contrib/database/views/handler.py
   │        │        └─ 0.002 exists  django/db/models/query.py:806
   │        │              [19 frames hidden]  django, copy
   │        ├─ 0.003 public_row_updated  fwego/contrib/database/ws/public/rows/signals
   │        │  ├─ 0.002 _serialize_row  fwego/contrib/database/ws/public/rows/signals.
   │        │  │  ├─ 0.001 get_row_serializer_class  fwego/contrib/database/api/rows/s
   │        │  │  │  └─ 0.001 get_response_serializer_field  fwego/contrib/database/fi
   │        │  │  │     └─ 0.001 get_serializer_field  fwego/contrib/database/fields/f
   ...
   │        └─ 0.003 before_row_update  fwego/contrib/database/ws/rows/signals.py:37
   │           ├─ 0.002 data  rest_framework/serializers.py:546
   │           │     [13 frames hidden]  rest_framework, django, copy
   │           └─ 0.001 get_row_serializer_class  fwego/contrib/database/api/rows/seri
   │              └─ 0.001 get_serializer_class  fwego/api/utils.py:254
