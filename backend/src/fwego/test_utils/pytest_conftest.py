...
from fwego.core.context import clear_current_workspace_id
from fwego.core.exceptions import PermissionDenied
from fwego.core.jobs.registries import job_type_registry
from fwego.core.permission_manager import CorePermissionManagerType
...
from fwego.core.trash.trash_types import WorkspaceTrashableItemType
from fwego.core.user_sources.registries import UserSourceCount
...
def stub_user_source_registry(data_fixture, mutable_user_source_registry, fake):
    from fwego.core.user_sources.registries import UserSourceType
...
def enable_singleton_testing(settings):
    ...
    with patch(
        "fwego.celery_singleton_backend.get_redis_connection",
...
def mutable_generative_ai_model_type_registry():
    from fwego.core.generative_ai.registries import generative_ai_model_type_registry
