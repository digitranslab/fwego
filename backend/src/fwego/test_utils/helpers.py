...
def setup_interesting_test_table(
    ...
    interesting fwego edge cases worth testing when writing a comprehensive "does this
    feature work with all the fwego fields" test.

    :param data_fixture: The fwego testing data_fixture object
    :return:
    """
...
def register_instance_temporarily(registry, instance):
    """
    A context manager to allow tests to register a new instance into a Fwego
