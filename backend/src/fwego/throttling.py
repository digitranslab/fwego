...
FWEGO_CONCURRENCY_THROTTLE_REQUEST_ID = "fwego_concurrency_throttle_request_id"
...
class ConcurrentUserRequestsThrottle(
    SimpleRateThrottle, metaclass=fwego_trace_methods(tracer)
):
    """
    ...
    def parse_rate(self, rate):
        duration = settings.FWEGO_CONCURRENT_USER_REQUESTS_THROTTLE_TIMEOUT
    ...
    def allow_request(self, request, view):
        ...
        if allowed:
            ...
            setattr(django_request, FWEGO_CONCURRENCY_THROTTLE_REQUEST_ID, request_id)
    ...
    def on_request_processed(cls, request):
        request_id = getattr(request, FWEGO_CONCURRENCY_THROTTLE_REQUEST_ID, None)
