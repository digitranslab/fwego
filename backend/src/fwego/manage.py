...
def enable_debugger():
    ...
    debugger_enabled = bool(os.environ.get("FWEGO_BACKEND_DEBUGGER_ENABLED"))
    if debugger_enabled:
        import debugpy

        debugger_port = int(os.environ.get("FWEGO_BACKEND_DEBUGGER_PORT", 5678))
        ...
        print(
            ...
            "FWEGO_BACKEND_DEBUGGER_ENABLED=True to enable it."
        )
