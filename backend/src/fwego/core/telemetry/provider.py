...
from fwego.core.telemetry.env_overrides_parser import get_sampler_overrides_from_str

FWEGO_CUSTOM_OTEL_SAMPLER_ENV_VAR_NAME = "OTEL_PER_MODULE_SAMPLER_OVERRIDES"
        ...
        **kwargs,
        ...
        self.default_sampler_override_per_instrumented_module_name = (
            get_sampler_overrides_from_str(
                os.getenv(FWEGO_CUSTOM_OTEL_SAMPLER_ENV_VAR_NAME, "")
            )
        )
