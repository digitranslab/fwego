...
from fwego.core.models import Application, TrashEntry, Workspace
from fwego.core.telemetry.utils import fwego_trace_methods
from fwego.core.trash.exceptions import (
...
from fwego.core.trash.registries import TrashableItemType, trash_item_type_registry
from fwego.core.trash.signals import permanently_deleted
...
class TrashHandler(metaclass=fwego_trace_methods(tracer)):
    @staticmethod
    def trash(
        ...
        visible or usable in Fwego. However, any user with access to its workspace can
    ...
    def restore_item(
        ...
        """
        Restores an item from the trash re-instating it back in Fwego exactly how it
...
def _get_trash_entry(
    ...
    """
    Gets the trash entry for a particular resource in fwego which has been
    trashed.
    ...
    :returns The trash entry for the specified fwego item.
