...
from fwego.core.jobs.exceptions import JobCancelled
...
@app.task(
    bind=True,
    queue="export",
    soft_time_limit=settings.FWEGO_JOB_SOFT_TIME_LIMIT,
)
...
def setup_periodic_tasks(sender, **kwargs):
    sender.add_periodic_task(
        timedelta(minutes=settings.FWEGO_JOB_CLEANUP_INTERVAL_MINUTES),
        clean_up_jobs.s(),
    )
