...
class FwegoVersionUpgradeNotificationType(CliNotificationTypeMixin, NotificationType):
    type = "fwego_version_upgrade"
    ...
    def prompt_for_args_in_cli_and_create_notification(cls):
        ...
        release_notes_url = input(
            "Enter the release notes URL (i.e. https://fwego.io/blog/1-19-release-of-fwego): "
        )
