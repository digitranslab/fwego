...
class AccountDeletionScheduled(BaseEmailMessage):
    template_name = "fwego/core/user/account_deletion_scheduled.html"
    ...
    def get_subject(self):
        return _("Account deletion scheduled - Fwego")
...
class AccountDeleted(BaseEmailMessage):
    template_name = "fwego/core/user/account_deleted.html"
    ...
    def get_subject(self):
        return _("Account permanently deleted - Fwego")
...
class AccountDeletionCanceled(BaseEmailMessage):
    template_name = "fwego/core/user/account_deletion_cancelled.html"
    ...
    def get_subject(self):
        return _("Account deletion cancelled - Fwego")
