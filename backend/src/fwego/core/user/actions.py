...
from fwego.core.action.scopes import RootActionScopeType
...
from fwego.core.models import Template, User
...
class SignInUserActionType(ActionType):
    ...
    def do(
        ...
        rate_limit(
            rate=settings.FWEGO_LOGIN_ACTION_LOG_LIMIT,
