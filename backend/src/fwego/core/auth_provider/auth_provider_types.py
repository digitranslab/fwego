...
from fwego.core.auth_provider.models import (
    AuthProviderModel,
    PasswordAuthProviderModel,
)
from fwego.core.auth_provider.registries import BaseAuthProviderType
from fwego.core.auth_provider.types import AuthProviderModelSubClass, UserInfo
from fwego.core.auth_provider.validators import validate_domain
...
class AuthProviderType(BaseAuthProviderType):
    """
    Base auth provider type class for Fwego auth providers.
    """
    ...
    def get_user_and_sign_in(
        ...
        from fwego.core.actions import AcceptWorkspaceInvitationActionType
        from fwego.core.user.actions import SignInUserActionType
        ...
        is_original_provider_check_needed = (
            not settings.FWEGO_ALLOW_MULTIPLE_SSO_PROVIDERS_FOR_SAME_ACCOUNT
        )
        if (
            is_original_provider_check_needed
    ...
    def create_user(
        ...
        from fwego.core.user.actions import CreateUserActionType
    ...
    def export_serialized(self) -> Dict[str, Any]:
        ...
        from fwego.api.auth_provider.serializers import AuthProviderSerializer
