...
from fwego.core.handler import CoreHandler, WorkspaceForUpdate
from fwego.core.import_export.handler import ImportExportHandler
from fwego.core.models import (
    Application,
...
class DeleteWorkspaceActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, workspace: WorkspaceForUpdate):
        ...
        See fwego.core.handler.CoreHandler.delete_workspace for more details.
...
class CreateWorkspaceActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, workspace_name: str) -> WorkspaceUser:
        ...
        fwego.core.handler.CoreHandler.create_workspace for more details. Undoing this
...
class UpdateWorkspaceActionType(UndoableActionType):
    ...
    def do(
        ...
        workspace. See fwego.core.handler.CoreHandler.upgrade_workspace for more
...
class OrderWorkspacesActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, workspace_ids_in_order: List[int]) -> None:
        ...
        See fwego.core.handler.CoreHandler.order_workspaces for more details. Undoing
...
class OrderApplicationsActionType(UndoableActionType):
    ...
    def do(
        ...
        `fwego.core.handler.CoreHandler.order_applications` for further details. When
...
class CreateApplicationActionType(UndoableActionType):
    ...
    def do(
        ...
        fwego.core.handler.CoreHandler.create_application for further details.
...
class DeleteApplicationActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, application: Application) -> None:
        ...
        See fwego.core.handler.CoreHandler.delete_application for further details.
...
class UpdateApplicationActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, application: Application, **kwargs) -> Application:
        ...
        See fwego.core.handler.CoreHandler.update_application for further details.
...
class DuplicateApplicationActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.core.handler.CoreHandler.duplicate_application for further details.
        Undoing this action trashes the application and redoing restores it.
...
class InstallTemplateActionType(UndoableActionType):
    ...
    def do(
        ...
        fwego.core.handler.CoreHandler.install_template for further details.
...
class CreateWorkspaceInvitationActionType(ActionType):
    ...
    def do(
        ...
        Look into fwego.core.handler.CoreHandler.create_workspace_invitation for
        further details.
...
class DeleteWorkspaceInvitationActionType(ActionType):
    ...
    def do(
        ...
        Look into fwego.core.handler.CoreHandler.delete_workspace_invitation
        for further details.
...
class AcceptWorkspaceInvitationActionType(ActionType):
    ...
    def do(
        ...
        Look into fwego.core.handler.CoreHandler.accept_workspace_invitation for
        further details.
        """
...
class RejectWorkspaceInvitationActionType(ActionType):
    ...
    def do(
        ...
        """
        Accepts an existing workspace invitation.
        Look into fwego.core.handler.CoreHandler.reject_workspace_invitation for
        further details.
        """
...
class UpdateWorkspaceInvitationActionType(ActionType):
    ...
    def do(
        ...
        Look into fwego.core.handler.CoreHandler.update_workspace_invitation for
        further details.
        """
...
class LeaveWorkspaceActionType(ActionType):
    ...
    def do(cls, user: AbstractUser, workspace: Workspace):
        ...
        Look into fwego.core.handler.CoreHandler.leave_workspace for further details.
        """
