...
from fwego.core.models import Application, Snapshot, Workspace
...
from fwego.core.snapshots.exceptions import (
...
class SnapshotHandler:
    ...
    def create(self, application_id, performed_by, name):
        ...
        max_snapshots = settings.FWEGO_MAX_SNAPSHOTS_PER_GROUP
    ...
    def delete_expired(self) -> None:
        ...
        FWEGO_SNAPSHOT_EXPIRATION_TIME_DAYS and schedules their deletion.
        """

        threshold = datetime.now(tz=timezone.utc) - timedelta(
            days=settings.FWEGO_SNAPSHOT_EXPIRATION_TIME_DAYS
        )
