...
from fwego.core.exceptions import LockConflict
from fwego.core.telemetry.utils import fwego_trace, fwego_trace_methods
...
class ActionHandler(metaclass=fwego_trace_methods(tracer)):
