...
from fwego.cachalot_patch import clear_cachalot_cache
...
class CoreConfig(AppConfig):
    ...
    def ready(self):
        ...
        from fwego.core.fields import LenientDecimalField
        ...
        from fwego.core.trash.trash_types import (
        ...
        from fwego.core.formula.runtime_formula_types import (
            RuntimeAdd,
            RuntimeConcat,
            RuntimeGet,
        )
        ...
        from fwego.core.actions import (
        ...
        from fwego.core.snapshots.actions import (
        ...
        from fwego.core.trash.actions import (
        ...
        from fwego.core.user.actions import (
        ...
        from fwego.core.action.scopes import (
        ...
        from fwego.api.notifications.user_data_types import (
            UnreadUserNotificationsCountPermissionsDataType,
        )
        from fwego.api.user.registries import user_data_registry
        from fwego.api.user.user_data_types import GlobalPermissionsDataType
        ...
        from fwego.core.auth_provider.auth_provider_types import (
        ...
        import fwego.core.notifications.receivers  # noqa: F401
        import fwego.core.notifications.tasks  # noqa: F401
        from fwego.core.notification_types import (
        ...
        from fwego.core.notifications.registries import notification_type_registry
        ...
        notification_type_registry.register(FwegoVersionUpgradeNotificationType())

        from fwego.core.generative_ai.generative_ai_model_types import (
        ...
        from fwego.core.generative_ai.registries import (
        ...
        import fwego.core.posthog  # noqa: F403, F401
    ...
    def _setup_health_checks(self):
        ...
        from fwego.core.integrations.object_scopes import IntegrationObjectScopeType
        from fwego.core.registries import (
            object_scope_type_registry,
            operation_type_registry,
        )
        ...
        from fwego.core.user_sources.object_scopes import UserSourceObjectScopeType
        ...
        import fwego.core.import_export.tasks  # noqa: F403, F401
        import fwego.core.integrations.receivers  # noqa: F403, F401


# noinspection PyPep8Naming
def start_sync_templates_task_after_migrate(sender, **kwargs):
    from fwego.core.tasks import sync_templates_task

    if settings.FWEGO_TRIGGER_SYNC_TEMPLATES_AFTER_MIGRATION and not settings.TESTS:
        print(
