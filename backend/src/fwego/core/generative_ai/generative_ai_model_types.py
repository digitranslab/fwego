...
from fwego.core.generative_ai.exceptions import AIFileError, GenerativeAIPromptError
from fwego.core.generative_ai.types import FileId
...
class BaseOpenAIGenerativeAIModelType(GenerativeAIModelType):
    ...
    def get_settings_serializer(self):
        from fwego.api.generative_ai.serializers import OpenAISettingsSerializer
...
class OpenAIGenerativeAIModelType(
    ...
    def get_max_file_size(self) -> int:
        return min(512, settings.FWEGO_OPENAI_UPLOADED_FILE_SIZE_LIMIT_MB)
...
class AnthropicGenerativeAIModelType(GenerativeAIModelType):
    ...
    def get_api_key(self, workspace=None):
        return (
            self.get_workspace_setting(workspace, "api_key")
            or settings.FWEGO_ANTHROPIC_API_KEY
        )

    def get_enabled_models(self, workspace=None):
        workspace_models = self.get_workspace_setting(workspace, "models")
        return workspace_models or settings.FWEGO_ANTHROPIC_MODELS
    ...
    def get_settings_serializer(self):
        from fwego.api.generative_ai.serializers import AnthropicSettingsSerializer
...
class MistralGenerativeAIModelType(GenerativeAIModelType):
    ...
    def get_api_key(self, workspace=None):
        return (
            self.get_workspace_setting(workspace, "api_key")
            or settings.FWEGO_MISTRAL_API_KEY
        )

    def get_enabled_models(self, workspace=None):
        workspace_models = self.get_workspace_setting(workspace, "models")
        return workspace_models or settings.FWEGO_MISTRAL_MODELS
    ...
    def get_settings_serializer(self):
        from fwego.api.generative_ai.serializers import MistralSettingsSerializer
...
class OllamaGenerativeAIModelType(GenerativeAIModelType):
    ...
    def get_host(self, workspace=None):
        return (
            ...
            or settings.FWEGO_OLLAMA_HOST
        )

    def get_enabled_models(self, workspace=None):
        workspace_models = self.get_workspace_setting(workspace, "models")
        return workspace_models or settings.FWEGO_OLLAMA_MODELS
    ...
    def get_settings_serializer(self):
        from fwego.api.generative_ai.serializers import OllamaSettingsSerializer
...
class OpenRouterGenerativeAIModelType(BaseOpenAIGenerativeAIModelType):
    ...
    def get_api_key(self, workspace=None):
        return (
            self.get_workspace_setting(workspace, "api_key")
            or settings.FWEGO_OPENROUTER_API_KEY
        )

    def get_enabled_models(self, workspace=None):
        workspace_models = self.get_workspace_setting(workspace, "models")
        return workspace_models or settings.FWEGO_OPENROUTER_MODELS

    def get_organization(self, workspace=None):
        return (
            self.get_workspace_setting(workspace, "organization")
            or settings.FWEGO_OPENROUTER_ORGANIZATION
        )
    ...
    def get_settings_serializer(self):
        from fwego.api.generative_ai.serializers import OpenRouterSettingsSerializer
