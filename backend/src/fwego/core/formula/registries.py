...
from fwego.core.formula.argument_types import FwegoRuntimeFormulaArgumentType
...
class RuntimeFormulaFunction(ABC, Instance):
    ...
    @property
    def args(self) -> Optional[List[FwegoRuntimeFormulaArgumentType]]:
        """
...
class FwegoRuntimeFormulaFunctionRegistry(
...
formula_runtime_function_registry = FwegoRuntimeFormulaFunctionRegistry()
