...
from fwego.api.health.serializers import (
...
from fwego.core.health.handler import HealthCheckHandler
from fwego.core.health.utils import get_celery_queue_size
...
class EmailTesterView(APIView):
    ...
    @extend_schema(
        ...
        "testing Fwego's email configuration as errors are clearly "
        "returned.",
        responses={
...
class CeleryQueueSizeExceededView(APIView):
    ...
    @extend_schema(
        ...
        description=(
            ...
            f"{settings.FWEGO_MAX_HEALTHY_CELERY_QUEUE_SIZE} in all queues provided. "
    ...
    def get(self, request: Request) -> Response:
        ...
        for queue in queues:
            ...
            if queue_size >= settings.FWEGO_MAX_HEALTHY_CELERY_QUEUE_SIZE:
