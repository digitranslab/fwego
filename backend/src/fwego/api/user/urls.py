...
from .views import (
    ...
    SendVerifyEmailView,
    ShareOnboardingDetailsWithFwegoView,
    UndoView,
    UserView,
...
urlpatterns = [
    ...
    re_path(
        r"^share-onboarding-details-with-fwego/$",
        ShareOnboardingDetailsWithFwegoView.as_view(),
        name="share_onboarding_details_with_fwego",
    ),
