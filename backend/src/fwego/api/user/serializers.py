...
from fwego.api.sessions import set_user_session_data_from_request
from fwego.api.user.jwt import get_user_from_token
from fwego.api.user.registries import user_data_registry
from fwego.api.user.validators import language_validation, password_validation
from fwego.api.workspaces.invitations.serializers import (
...
from fwego.core.models import Settings, Template, UserProfile
...
from fwego.core.user.utils import (
...
class ShareOnboardingDetailsWithFwegoSerializer(serializers.Serializer):
