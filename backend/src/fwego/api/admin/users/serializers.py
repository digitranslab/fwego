...
from fwego.api.user.validators import password_validation
...
_USER_ADMIN_SERIALIZER_API_DOC_KWARGS = {
    ...
    "is_staff": {
        ...
        "workspaces and Fwego's admin areas. "
    },
}
...
class FwegoImpersonateAuthTokenSerializer(serializers.Serializer):
    """
