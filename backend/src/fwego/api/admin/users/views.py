...
from fwego.api.admin.users.errors import (
    USER_ADMIN_ALREADY_EXISTS,
    USER_ADMIN_CANNOT_DEACTIVATE_SELF,
    USER_ADMIN_CANNOT_DELETE_SELF,
    USER_ADMIN_UNKNOWN_USER,
)
from fwego.api.admin.users.serializers import (
    UserAdminCreateSerializer,
    UserAdminResponseSerializer,
    UserAdminUpdateSerializer,
)
from fwego.api.admin.views import AdminListingView
from fwego.api.decorators import map_exceptions, validate_body
from fwego.api.schemas import get_error_schema
from fwego.api.user.schemas import authenticate_user_schema
from fwego.api.user.serializers import get_all_user_data_serialized
from fwego.core.admin.users.exceptions import (
    CannotDeactivateYourselfException,
    CannotDeleteYourselfException,
    UserDoesNotExistException,
)
from fwego.core.admin.users.handler import UserAdminHandler
from fwego.core.user.exceptions import DeactivatedUserException, UserAlreadyExist
from fwego.core.user.utils import generate_session_tokens_for_user

from .serializers import FwegoImpersonateAuthTokenSerializer
...
class UserAdminImpersonateView(GenericAPIView):
    ...
    permission_classes = (IsAdminUser,)
    serializer_class = FwegoImpersonateAuthTokenSerializer
    ...
    @extend_schema(
        ...
        request=FwegoImpersonateAuthTokenSerializer,
        responses={
