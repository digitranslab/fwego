...
from fwego.api.applications.errors import (
    ERROR_APPLICATION_DOES_NOT_EXIST,
    ERROR_APPLICATION_OPERATION_NOT_SUPPORTED,
)
from fwego.api.authentication import JSONWebTokenAuthentication
...
from fwego.api.user.errors import (
    ERROR_INVALID_CREDENTIALS,
    ERROR_INVALID_REFRESH_TOKEN,
    ERROR_REFRESH_TOKEN_ALREADY_BLACKLISTED,
)
from fwego.api.user.views import BlacklistJSONWebToken
from fwego.api.user_sources.errors import (
...
from fwego.api.user_sources.schemas import authenticate_schema, refresh_schema
from fwego.api.user_sources.serializers import (
...
from fwego.core.app_auth_providers.exceptions import (
    AppAuthenticationProviderTypeDoesNotExist,
    IncompatibleUserSourceType,
)
from fwego.core.auth_provider.exceptions import CannotCreateAuthProvider
from fwego.core.exceptions import (
    ApplicationDoesNotExist,
    ApplicationOperationNotSupported,
)
from fwego.core.handler import CoreHandler
from fwego.core.user.exceptions import RefreshTokenAlreadyBlacklisted
from fwego.core.user_sources.exceptions import (
...
from fwego.core.user_sources.jwt_token import UserSourceToken
...
class UserSourceTokenRefreshView(APIView):
    ...
    @extend_schema(
        ...
        description=(
            ...
            "on Fwego with a user source user starting from a valid refresh token."
        ),
        responses={
            200: refresh_schema,
