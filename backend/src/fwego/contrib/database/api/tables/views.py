...
from fwego.contrib.database.file_import.job_types import FileImportJobType
from fwego.contrib.database.handler import DatabaseHandler
from fwego.contrib.database.operations import (
    CreateTableDatabaseTableOperationType,
    ListTablesDatabaseTableOperationType,
)
from fwego.contrib.database.table.actions import (
...
from fwego.contrib.database.table.job_types import DuplicateTableJobType
...
from fwego.core.exceptions import ApplicationDoesNotExist, UserNotInWorkspace
...
class TablesView(APIView):
    ...
    def post(self, request, data, database_id):
        ...
        limit = settings.FWEGO_INITIAL_CREATE_SYNC_TABLE_DATA_LIMIT
        if limit and len(data) > limit:
            raise InitialSyncTableDataLimitExceeded(
                f"It is not possible to import more than "
                f"{settings.FWEGO_INITIAL_CREATE_SYNC_TABLE_DATA_LIMIT} rows "
