...
from fwego.api.search.serializers import SearchQueryParamSerializer
...
from fwego.contrib.database.api.views.grid.serializers import (
    GridViewFieldOptionsSerializer,
)
from fwego.contrib.database.api.views.serializers import FieldOptionsField
from fwego.contrib.database.api.views.utils import (
        ...
        parameters=[
            ...
            *ADHOC_FILTERS_API_PARAMS,
            OpenApiParameter(
                ...
                "for the Fwego group by feature.",
            ),
        ],
        tags=["Database table grid view"],
