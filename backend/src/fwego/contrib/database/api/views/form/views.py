...
from fwego.contrib.database.api.rows.errors import ERROR_CANNOT_CREATE_ROWS_IN_TABLE
...
from fwego.contrib.database.fields.models import FileField, LongTextField
from fwego.contrib.database.rows.exceptions import CannotCreateRowsInTable
from fwego.contrib.database.views.actions import SubmitFormActionType
from fwego.contrib.database.views.exceptions import (
    NoAuthorizationToPubliclySharedView,
    ViewDoesNotExist,
)
from fwego.contrib.database.views.handler import ViewHandler
from fwego.contrib.database.views.models import FormView
from fwego.contrib.database.views.registries import view_ownership_type_registry
from fwego.contrib.database.views.validators import (
...
class FormUploadFileView(APIView):
    ...
    @extend_schema(
        ...
        description=(
            "Uploads a file anonymously to Fwego by uploading the file "
