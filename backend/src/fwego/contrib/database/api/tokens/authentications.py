...
from fwego.api.sessions import set_user_remote_addr_ip_from_request
...
from fwego.core.telemetry.utils import setup_user_in_baggage_and_spans
...
class JSONWebTokenAuthenticationExtension(OpenApiAuthenticationExtension):
    target_class = (
        "fwego.contrib.database.api.tokens.authentications.TokenAuthentication"
    )
    name = "Database token"
