...
from fwego.contrib.database.table.object_scopes import DatabaseTableObjectScopeType
from fwego.contrib.database.table.operations import (
    ListenToAllDatabaseTableEventsOperationType,
)
from fwego.contrib.database.ws.pages import TablePageType
from fwego.core.exceptions import PermissionException
from fwego.core.mixins import TrashableModelMixin
from fwego.core.models import Workspace
from fwego.core.object_scopes import WorkspaceObjectScopeType
from fwego.core.registries import (
    PermissionManagerType,
    object_scope_type_registry,
    subject_type_registry,
)
from fwego.core.subjects import UserSubjectType
...
def setup_new_background_update_and_search_columns(self, table_id: int):
    """
    Responsible for migrating Fwego tables into using our new Postgres
...
def update_table_usage(self, table_id: int, row_count: int = 0):
    from fwego.contrib.database.table.handler import TableUsageHandler
