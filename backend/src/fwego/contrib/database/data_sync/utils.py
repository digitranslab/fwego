...
from fwego.contrib.database.fields.models import Field, SelectOption
...
def update_fwego_field_select_options(
    ...
    :param source_options: A list of the options that must be created for the
        `fwego_field`.
    :param fwego_field: The Fwego field where the select options must be created
        for.
