...
from fwego.contrib.database.api.utils import get_include_exclude_field_ids
from fwego.contrib.database.db.schema import safe_django_schema_editor
from fwego.contrib.database.fields.exceptions import FieldNotInTable
...
from fwego.contrib.database.fields.operations import ReadFieldOperationType
...
from fwego.contrib.database.search.handler import SearchModes
from fwego.contrib.database.table.models import GeneratedTableModel, Table
from fwego.contrib.database.views.exceptions import ViewOwnershipTypeDoesNotExist
...
from fwego.contrib.database.views.view_filter_groups import ViewGroupedFiltersAdapter
from fwego.core.db import specific_iterator, transaction_atomic
...
class ViewIndexingHandler(metaclass=fwego_trace_methods(tracer)):
    @classmethod
    ...
    def schedule_index_update(cls, view: View):
        ...
        from fwego.contrib.database.views.tasks import schedule_view_index_update
...
class ViewHandler(metaclass=fwego_trace_methods(tracer)):
