...
from fwego.contrib.database.fields.field_filters import OptionallyAnnotatedQ
...
if TYPE_CHECKING:
    ...
    from fwego.contrib.database.table.models import FieldObject, Table
    from fwego.contrib.database.views.models import FormView, View
...
class ViewType(
    ...
    Example:
        ...
        from fwego.contrib.database.views.registry import ViewType, view_type_registry
    ...
    def import_serialized(
        ...
        if "database_views" not in id_mapping:
            ...
            # `src/fwego/contrib/database/table/handler.py::duplicate_table`
...
class ViewTypeRegistry(
    ...
    is an abstraction made specifically for Fwego. If added to the registry a user can
...
class ViewFilterType(Instance):
    ...
    Example:
        from fwego.contrib.database.views.registry import (
    ...
    def get_filter(self, field_name, value, model_field, field) -> OptionallyAnnotatedQ:
        ...
        :param field: The instance of the underlying fwego field.
        :type field: Field
...
class DecoratorValueProviderType(CustomFieldsInstanceMixin, Instance):
    ...
    def model_class(self):
        from fwego.contrib.database.views.models import ViewDecoration
...
# throughout the whole Fwego application to add a new view type.
