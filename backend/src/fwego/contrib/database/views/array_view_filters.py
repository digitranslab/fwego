...
from fwego.contrib.database.formula import FwegoFormulaTextType
...
class HasEmptyValueViewFilterType(ViewFilterType):
    ...
    compatible_field_types = [
        FormulaFieldType.compatible_with_formula_types(
            FormulaFieldType.array_of(FwegoFormulaTextType.type),
            FormulaFieldType.array_of(FwegoFormulaCharType.type),
            FormulaFieldType.array_of(FwegoFormulaURLType.type),
            FormulaFieldType.array_of(FwegoFormulaSingleSelectType.type),
        ),
    ]
...
class HasValueEqualViewFilterType(ViewFilterType):
    ...
    compatible_field_types = [
        FormulaFieldType.compatible_with_formula_types(
            ...
            FormulaFieldType.array_of(FwegoFormulaCharType.type),
            FormulaFieldType.array_of(FwegoFormulaURLType.type),
            FormulaFieldType.array_of(FwegoFormulaBooleanType.type),
            FormulaFieldType.array_of(FwegoFormulaSingleSelectType.type),
        ),
    ]
