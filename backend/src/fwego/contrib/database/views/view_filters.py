...
class EqualViewFilterType(ViewFilterType):
    ...
    compatible_field_types = [
        ...
        FormulaFieldType.compatible_with_formula_types(
            ...
            FwegoFormulaDurationType.type,
            FwegoFormulaURLType.type,
        ),
    ]
...
class ContainsViewFilterType(ViewFilterType):
    ...
    compatible_field_types = [
        ...
        FormulaFieldType.compatible_with_formula_types(
            ...
            FwegoFormulaURLType.type,
            FwegoFormulaSingleSelectType.type,
            FwegoFormulaMultipleSelectType.type,
        ),
    ]
...
class NumericComparisonViewFilterType(ViewFilterType):
    ...
    compatible_field_types = [
        ...
        DurationFieldType.type,
        FormulaFieldType.compatible_with_formula_types(
            FwegoFormulaNumberType.type, FwegoFormulaDurationType.type
        ),
    ]
...
class TimezoneAwareDateViewFilterType(ViewFilterType):
    compatible_field_types = [
        ...
        LastModifiedFieldType.type,
        CreatedOnFieldType.type,
        FormulaFieldType.compatible_with_formula_types(FwegoFormulaDateType.type),
    ]
    ...
    def get_filter(
        ...
        :param model_field: The Django model field of the database table that is
            being filtered.
        :param field: The Fwego field instance containing the metadata related
            to the field.
...
class EmptyViewFilterType(ViewFilterType):
    ...
    compatible_field_types = [
        ...
        FormulaFieldType.compatible_with_formula_types(
            ...
            FwegoFormulaDateType.type,
            FwegoFormulaBooleanType.type,
            FwegoFormulaDateIntervalType.type,
            FwegoFormulaDurationType.type,
            FwegoFormulaURLType.type,
            FwegoFormulaSingleSelectType.type,
            FwegoFormulaMultipleSelectType.type,
