...
from fwego.contrib.database.action.scopes import (
...
from fwego.contrib.database.rows.exceptions import CannotCreateRowsInTable
...
from fwego.contrib.database.views.handler import FieldOptionsDict, ViewHandler
...
from fwego.core.action.models import Action
...
class CreateViewFilterActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.contrib.database.views.handler.ViewHandler.create_filter
...
class UpdateViewFilterActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.contrib.database.views.handler.ViewHandler.update_filter
...
class DeleteViewFilterActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.contrib.database.views.handler.ViewHandler.delete_filter
...
class CreateViewFilterGroupActionType(UndoableActionType):
    ...
    def do(
        ...
        fwego.contrib.database.views.handler.ViewHandler.create_filter_group
...
class UpdateViewFilterGroupActionType(UndoableActionType):
    ...
    def do(
        ...
        fwego.contrib.database.views.handler.ViewHandler.update_filter_group
...
class DeleteViewFilterGroupActionType(UndoableActionType):
    ...
    def do(
        ...
        fwego.contrib.database.views.handler.ViewHandler.delete_filter_group
...
class CreateViewSortActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.contrib.database.views.handler.ViewHandler.create_sort
...
class UpdateViewSortActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.contrib.database.views.handler.ViewHandler.update_sort
...
class DeleteViewSortActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, view_sort: ViewSort):
        ...
        See fwego.contrib.database.views.handler.ViewHandler.delete_sort
...
class OrderViewsActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.contrib.views.handler.ViewsHandler.order_views for further details.
...
class UpdateViewFieldOptionsActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.contrib.database.views.handler.ViewHandler.update_field_options
        for more.
...
class RotateViewSlugActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, view: View) -> View:
        ...
        See fwego.contrib.database.views.handler.ViewHandler.rotate_slug for more.
...
class UpdateViewActionType(UndoableActionType):
    ...
    def do(
        ...
        **data,
        ...
        See fwego.contrib.database.views.handler.ViewHandler.update_view for more.
...
class CreateViewActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, table: Table, type_name: str, **kwargs) -> View:
        ...
        See fwego.contrib.views.handler.ViewsHandler.create_view for further details.
...
class DeleteViewActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, view: View):
        ...
        See fwego.contrib.views.handler.ViewsHandler.delete_view for further details.
...
class CreateDecorationActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.contrib.decorations.handler.DecorationsHandler.create_decoration
        for further details.
...
class UpdateDecorationActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.contrib.decorations.handler.DecorationsHandler.update_decoration
        for further details.
...
class DeleteDecorationActionType(UndoableActionType):
    ...
    def do(cls, view_decoration: ViewDecoration, user: AbstractUser):
        ...
        See fwego.contrib.decorations.handler.DecorationsHandler.delete_decoration
        for further details.
...
class CreateViewGroupByActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.contrib.database.views.handler.ViewHandler.create_group
...
class UpdateViewGroupByActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.contrib.database.views.handler.ViewHandler.update_group
...
class DeleteViewGroupByActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, view_group_by: ViewGroupBy):
        ...
        See fwego.contrib.database.views.handler.ViewHandler.delete_group
