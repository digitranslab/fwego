...
from fwego.core.telemetry.utils import add_fwego_trace_attrs, fwego_trace
...
def run_periodic_fields_updates(
    ...
    for field_type_instance in field_type_registry.get_all():
        ...
        threshold = now - timedelta(
            minutes=settings.FWEGO_PERIODIC_FIELD_UPDATE_UNUSED_WORKSPACE_INTERVAL_MIN
        )
...
def _run_periodic_field_type_update_per_workspace(
    ...
    add_fwego_trace_attrs(update_now=update_now, workspace_id=workspace.id)
