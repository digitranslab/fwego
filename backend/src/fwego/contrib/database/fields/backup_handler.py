...
class FieldDataBackupHandler:
    """
    Backs up an arbitrary Fwego field by getting their model fields and deciding how
    ...
    useful for backing up the data due to Fwego actions to facilitate undoing them.
    ...
    class even if the Field/Table etc has been permanently deleted from Fwego.
    """
    ...
    def backup_field_data(
        ...
        :param field_to_backup: A Fwego field that you want to backup the data for.
    ...
    def restore_backup_data_into_field(
        ...
        backed up data back into an existing Fwego field of the same type.
        """
