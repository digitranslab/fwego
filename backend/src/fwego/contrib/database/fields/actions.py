...
from fwego.contrib.database.fields.backup_handler import (
    BackupData,
...
from fwego.contrib.database.fields.models import Field, SpecificFieldForUpdate
...
class UpdateFieldActionType(UndoableActionCustomCleanupMixin, UndoableActionType):
    ...
    def do(
        ...
        **kwargs,
        ...
        fwego.contrib.database.fields.handler.FieldHandler.update_field for further
...
class CreateFieldActionType(UndoableActionType):
    ...
    def do(
        ...
        **kwargs,
        ...
        See fwego.contrib.database.fields.handler.FieldHandler.create_field()
...
class DeleteFieldActionType(UndoableActionType):
    ...
    def do(
        ...
        See fwego.contrib.database.fields.handler.FieldHandler.delete_field()
        for more information.
