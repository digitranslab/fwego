...
from fwego.contrib.database.formula.types.exceptions import InvalidFormulaType

T = TypeVar("T", bound="FwegoFormulaType")
...
class FwegoFormulaTypeHasEmptyFwegoExpression(abc.ABC):
    @abc.abstractmethod
    def placeholder_empty_fwego_expression(self) -> Expression:
        """
    ...
    def is_blank(
        self,
        func_call: "tree.FwegoFunctionCall[UnTyped]",
        arg: "tree.FwegoExpression[FwegoFormulaValidType]",
    ) -> "tree.FwegoExpression[FwegoFormulaBooleanType]":
        """
        ...
        return equal_expr(
            ...
            self.placeholder_empty_fwego_expression(),
        )

    def try_coerce_to_not_null(
        self, expr: "tree.FwegoExpression[FwegoFormulaValidType]"
    ):
        placeholder_empty_fwego_expr = self.placeholder_empty_fwego_expression()
        return formula_function_registry.get("when_empty")(
            expr, placeholder_empty_fwego_expr
        )


class FwegoFormulaType(abc.ABC):
    @classmethod
    @property
    @abc.abstractmethod
    def type(cls) -> str:
    ...
    def fwego_field_type(self) -> str:
        """
        The Fwego field type that corresponds to this formula type and should be
        used to do various Fwego operations for a formula field of this type.
        """
    ...
    def construct_type_from_formula_field(cls: Type[T], formula_field) -> T:
        """
        Creates a FwegoFormulaType instance based on what is set on the formula field.
        :param formula_field: The formula field to get type info from.
        :return: A new FwegoFormulaType.
        """
    ...
    def new_type_with_user_and_calculated_options_merged(self: T, formula_field):
        """
        Generates a new merged FwegoFormulaType instance from what has been set on the
    ...
    def persist_onto_formula_field(self, formula_field):
        ...
        for attr in FWEGO_FORMULA_TYPE_ALLOWED_FIELDS:
    ...
    def get_fwego_field_instance_and_type(self) -> "tuple[Model, FieldType]":
        ...
        field_instance = fwego_field_type.from_fwego_formula_type(self)
        return field_instance, fwego_field_type
    ...
    def wrap_at_field_level(self, expr: "tree.FwegoExpression[FwegoFormulaType]"):
        """
    ...
    def unwrap_at_field_level(self, expr: "tree.FwegoExpression[FwegoFormulaType]"):
        """
    ...
    def collapse_many(self, expr: "tree.FwegoExpression[FwegoFormulaType]"):
        """
    ...
    def try_coerce_to_not_null(
        ...
        FwegoFormulaTypeHasEmptyFwegoExpression and has a
        placeholder_empty_fwego_expression method.
        """
    ...
    def add(
        self,
        add_func_call: "tree.FwegoFunctionCall[UnTyped]",
        arg1: "tree.FwegoExpression[FwegoFormulaValidType]",
        arg2: "tree.FwegoExpression[FwegoFormulaValidType]",
    ) -> "tree.FwegoExpression[FwegoFormulaType]":
    ...
    def minus(
        self,
        minus_func_call: "tree.FwegoFunctionCall[UnTyped]",
        arg1: "tree.FwegoExpression[FwegoFormulaValidType]",
        arg2: "tree.FwegoExpression[FwegoFormulaValidType]",
    ) -> "tree.FwegoExpression[FwegoFormulaType]":
    ...
    def multiply(
        self,
        multiply_func_call: "tree.FwegoFunctionCall[UnTyped]",
        arg1: "tree.FwegoExpression[FwegoFormulaValidType]",
        arg2: "tree.FwegoExpression[FwegoFormulaValidType]",
    ) -> "tree.FwegoExpression[FwegoFormulaType]":
    ...
    def divide(
        self,
        divide_func_call: "tree.FwegoFunctionCall[UnTyped]",
        arg1: "tree.FwegoExpression[FwegoFormulaValidType]",
        arg2: "tree.FwegoExpression[FwegoFormulaValidType]",
    ) -> "tree.FwegoExpression[FwegoFormulaType]":
    ...
    def get_search_expression(self, field, queryset):
        (
            field_instance,
            field_type,
        ) = self.get_fwego_field_instance_and_type()
...
class FwegoFormulaInvalidType(FwegoFormulaType):
    is_valid = False
    can_order_by = False
    can_group_by = False
    comparable_types = []
...
class FwegoFormulaValidType(FwegoFormulaType, abc.ABC):
    is_valid = True
    can_order_by = True
    ...
    def collapse_many(self, expr: "tree.FwegoExpression[FwegoFormulaType]"):
        from fwego.contrib.database.formula.registries import (
    ...
    def collapse_array_of_many(
        self, expr: "tree.FwegoExpression[FwegoFormulaType]"
    ):
        from fwego.contrib.database.formula.registries import (
            formula_function_registry,
        )
    ...
    def is_blank(
        ...
        from fwego.contrib.database.formula.types.formula_types import literal
    ...
    def cast_to_text(
        self,
        to_text_func_call: "tree.FwegoFunctionCall[UnTyped]",
        arg: "tree.FwegoExpression[FwegoFormulaValidType]",
    ) -> "tree.FwegoExpression[FwegoFormulaType]":
        """
        Given a expression which is an untyped FwegoToText function call this function
        should return an expression which results in this type being turning into a
        FwegoFormulaTextType.

        :param to_text_func_call: A FwegoToText function call expression where the
        ...
        :return: A typed FwegoExpression which results in arg turning into a text
            type.
        """
        ...
        return to_text_func_call.with_valid_type(FwegoFormulaTextType())
    ...
    def count(
        ...
        """
        Given a expression which is an untyped FwegoCount function call this function
        should return an expression which results in this type being turned into a
        FwegoFormulaNumberType.

        :param to_text_func_call: A FwegoCount function call expression where the
        ...
        :return: A typed FwegoExpression which results in arg turning into a number
            type.
        """
