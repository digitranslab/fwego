...
class FwegoStringAgg(OrderableAggMixin, Aggregate):
    function = "STRING_AGG"
...
class FwegoFilterExpression(Expression):
    """
    Fwego expression that works with field_name and value
...
class FileNameContainsExpr(FwegoFilterExpression):
    # fmt: off
    template = (
        f"""
        EXISTS(
...
class JSONArrayContainsValueExpr(FwegoFilterExpression):
    # fmt: off
    template = (
        f"""
        EXISTS(
...
class JSONArrayContainsValueSimilarToExpr(FwegoFilterExpression):
    # fmt: off
    template = (
        f"""
        EXISTS(
...
class JSONArrayContainsValueLengthLowerThanExpr(FwegoFilterExpression):
    # fmt: off
    template = (
        f"""
        EXISTS(
...
class JSONArrayAllAreExpr(FwegoFilterExpression):
    # fmt: off
    template = (
        f"""
...
class JSONArrayEqualSelectOptionIdExpr(FwegoFilterExpression):
    # fmt: off
    template = (
        f"""
        EXISTS(
...
class JSONArrayContainsSelectOptionValueExpr(FwegoFilterExpression):
    # fmt: off
    template = (
        f"""
        EXISTS(
...
class JSONArrayContainsSelectOptionValueSimilarToExpr(FwegoFilterExpression):
    # fmt: off
    template = (
        r"""
        EXISTS(
