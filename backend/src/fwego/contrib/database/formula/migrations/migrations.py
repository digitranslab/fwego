...
class FormulaMigration:
    """
    Represents how to migrate to a particular version of the Fwego formula language.
    """
...
def all_aggregate_formulas(formulas: QuerySet) -> Q:
    ...
    for f in formulas:
        ...
        except FwegoFormulaException:
            continue
    return Q(id__in=aggregate_formula_ids)


# A list containing all Fwego formula versions and how to migrate to them. The last
...
FWEGO_FORMULA_VERSION = FORMULA_MIGRATIONS.get_latest_version()
