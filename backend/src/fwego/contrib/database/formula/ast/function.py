...
from fwego.contrib.database.formula.types.type_checker import (
    ...
    FwegoSingleArgumentTypeChecker,
)
...
class ZeroArgumentFwegoFunction(
    ToDjangoExpressionGivenArgsMixin, FwegoFunctionDefinition
):
    """
    A helper sub type of a FwegoFunctionDefinition that lets the
    user talk specifically about a func with no arguments when implementing. Without
    this normal classes implementing FwegoFunctionDefinition need to faff
    ...
    def type_function(
        ...
        :return: A typed FwegoExpression, most probably just the original func_call
    ...
    def __call__(self) -> FwegoFunctionCall[FwegoFormulaType]:
        return self.call_and_type_with_args([])


class OneArgumentFwegoFunction(
    ToDjangoExpressionGivenArgsMixin, FwegoFunctionDefinition
):
    """
    A helper sub type of a FwegoFunctionDefinition that lets the
    user talk specifically about the single argument in a one arg func when implementing
    . Without this normal classes implementing FwegoFunctionDefinition need to faff
    about accessing argument lists etc.
    """
    ...
    @property
    @abc.abstractmethod
    def arg_type(self) -> FwegoSingleArgumentTypeChecker:
        """
        ...
        :return: A FwegoSingleArgumentTypeChecker
        """
    ...
    def __call__(
        self, arg: FwegoExpression[FwegoFormulaType]
    ) -> FwegoFunctionCall[FwegoFormulaType]:
...
def aggregate_wrapper(
    ...
    in a subquery. This is useful for FwegoFunctionDefinitions which need to
...
class TwoArgumentFwegoFunction(
    ToDjangoExpressionGivenArgsMixin, FwegoFunctionDefinition
):
    """
    A helper sub type of a FwegoFunctionDefinition that lets the
    ...
    @property
    @abc.abstractmethod
    def arg1_type(self) -> FwegoSingleArgumentTypeChecker:
        """
    ...
    @property
    @abc.abstractmethod
    def arg2_type(self) -> FwegoSingleArgumentTypeChecker:
        """
    ...
    def __call__(
        self,
        arg1: FwegoExpression[FwegoFormulaType],
        arg2: FwegoExpression[FwegoFormulaType],
    ) -> FwegoFunctionCall[FwegoFormulaType]:
        return self.call_and_type_with_args([arg1, arg2])


class ThreeArgumentFwegoFunction(
    ToDjangoExpressionGivenArgsMixin, FwegoFunctionDefinition
):
    @property
    def arg_types(self) -> FwegoArgumentTypeChecker:
    ...
    @property
    @abc.abstractmethod
    def arg3_type(self) -> FwegoSingleArgumentTypeChecker:
        """
    ...
    def __call__(
        ...
        arg1: FwegoExpression[FwegoFormulaType],
        arg2: FwegoExpression[FwegoFormulaType],
        arg3: FwegoExpression[FwegoFormulaType],
    ) -> FwegoFunctionCall[FwegoFormulaType]:
        return self.call_and_type_with_args([arg1, arg2, arg3])


class CollapseManyFwegoFunction:
    """
