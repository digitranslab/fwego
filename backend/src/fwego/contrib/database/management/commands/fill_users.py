...
from fwego.core.utils import grouper

User = get_user_model()

EMAIL_PREFIX = "fwego_prefix_to_ensure_we_never_accidentally_email_a_real_person_"
CLASHING_EMAIL_COUNTER = 0


class Command(BaseCommand):
    help = (
        "Fills fwego with random users. If no workspace is provided, a new one will be created, "
