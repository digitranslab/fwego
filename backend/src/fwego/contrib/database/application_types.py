...
from fwego.contrib.database.api.serializers import DatabaseSerializer
...
from fwego.contrib.database.models import Database, Field, View
...
from fwego.core.utils import ChildProgressBuilder, grouper
...
class DatabaseApplicationType(ApplicationType):
    ...
    def export_tables_serialized(
        ...
        for table in tables:
            ...
            serialized_rows = []
            row_count_limit = settings.FWEGO_IMPORT_EXPORT_TABLE_ROWS_COUNT_LIMIT
