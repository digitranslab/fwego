...
from fwego.core.utils import Progress, get_non_unique_values, grouper
...
class RowHandler(metaclass=fwego_trace_methods(tracer)):
    ...
    def get_unique_orders_before_row(
        ...
        if before_row:
            try:
                ...
                self.recalculate_row_orders(model.fwego_table, model)
    ...
    def map_user_field_name_dict_to_internal(
        ...
        the internal Fwego field names which look like field_1, field_2 and
        ...
        :return: A dictionary with the same values but the keys converted to the
            corresponding internal fwego field name (field_1,field_2 etc)
        """
    ...
    def force_create_rows(
        ...
        for index, row in enumerate(
            ...
            # This is a hack to make `FwegoExpressionField.pre_save` (called
