...
from fwego.contrib.database.rows.models import RowHistory
from fwego.contrib.database.rows.registries import change_row_history_registry
from fwego.contrib.database.rows.signals import rows_history_updated
...
def on_action_done_update_row_history(
    ...
    **kwargs,
    ...
    if settings.FWEGO_ROW_HISTORY_RETENTION_DAYS == 0:
        return
