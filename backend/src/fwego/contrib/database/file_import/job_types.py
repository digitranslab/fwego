...
from fwego.contrib.database.db.atomic import read_committed_single_table_transaction
...
from fwego.contrib.database.rows.actions import ImportRowsActionType
from fwego.contrib.database.rows.exceptions import ReportMaxErrorCountExceeded
from fwego.contrib.database.table.actions import CreateTableActionType
...
class FileImportJobType(JobType):
    ...
    job_exceptions_map = {
        ...
        ReservedFwegoFieldNameException: ERROR_RESERVED_FWEGO_FIELD_NAME[2],
        InvalidFwegoFieldName: ERROR_INVALID_FWEGO_FIELD_NAME[2],
    }
