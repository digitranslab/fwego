...
from fwego.contrib.database.table.operations import RestoreDatabaseTableOperationType
...
from fwego.core.usage.registries import workspace_storage_usage_item_registry
from fwego.ws.registries import page_registry


class DatabaseConfig(AppConfig):
    name = "fwego.contrib.database"
    ...
    def ready(self):
        ...
        from fwego.contrib.database.tokens.actions import (
        ...
        from fwego.contrib.database.views.actions import (
        ...
        from fwego.contrib.database.data_sync.actions import (
        ...
        from fwego.contrib.database.table.usage_types import (
        ...
        from fwego.contrib.database.views.usage_types import (
        ...
        from fwego.contrib.database.data_providers.registries import (
        ...
        # notification_types
        from fwego.contrib.database.fields.notification_types import (
            CollaboratorAddedToRowNotificationType,
            UserMentionInRichTextFieldNotificationType,
        )
        from fwego.contrib.database.views.notification_types import (
        ...
        import fwego.contrib.database.data_sync.signals  # noqa: F403, F401
        import fwego.contrib.database.search.signals  # noqa: F403, F401
        import fwego.contrib.database.ws.signals  # noqa: F403, F401

        post_migrate.connect(safely_update_formula_versions, sender=self)
        pre_migrate.connect(clear_generated_model_cache_receiver, sender=self)

        import fwego.contrib.database.fields.receivers  # noqa: F401
        import fwego.contrib.database.fields.tasks  # noqa: F401
        import fwego.contrib.database.rows.history  # noqa: F401
        import fwego.contrib.database.rows.tasks  # noqa: F401
        import fwego.contrib.database.search.tasks  # noqa: F401
        import fwego.contrib.database.table.receivers  # noqa: F401
        import fwego.contrib.database.views.tasks  # noqa: F401
...
def safely_update_formula_versions(sender, **kwargs):
    ...
    if apps is not None and not settings.DONT_UPDATE_FORMULAS_AFTER_MIGRATION:
        try:
            ...
            # We are starting up a version of fwego before formulas with versions
        ...
        from fwego.contrib.database.formula.migrations.handler import (
