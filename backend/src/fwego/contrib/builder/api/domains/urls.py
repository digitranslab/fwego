...
from fwego.contrib.builder.api.domains.public_views import (
...
from fwego.contrib.builder.api.domains.views import (
...
app_name = "fwego.contrib.builder.api.domains"
