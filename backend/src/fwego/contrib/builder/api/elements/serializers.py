...
from fwego.api.mixins import UnknownFieldRaisesExceptionSerializerMixin
...
from fwego.contrib.builder.elements.types import ElementsAndWorkflowActions
from fwego.contrib.builder.workflow_actions.registries import (
    builder_workflow_action_type_registry,
)
from fwego.core.exceptions import InstanceTypeDoesNotExist
...
class ElementSerializer(serializers.ModelSerializer):
    ...
    👉 Mind to update the
    fwego.contrib.builder.api.domains.serializer.PublicElementSerializer
