...
from fwego.contrib.builder.pages.constants import PAGE_PATH_PARAM_TYPE_CHOICES
from fwego.contrib.builder.pages.models import Page
from fwego.contrib.builder.pages.validators import path_param_name_validation
...
class PageSerializer(serializers.ModelSerializer):
    """
    👉 Mind to update the
    fwego.contrib.builder.api.domains.serializer.PublicPageSerializer
