...
import fwego.contrib.builder.domains.models
import fwego.contrib.builder.elements.models
import fwego.contrib.builder.pages.validators
import fwego.core.fields
import fwego.core.formula.field
import fwego.core.mixins
from fwego.contrib.builder.domains.models import CustomDomain, Domain


# fwego.contrib.builder.migrations.0006_delete_all_pages
...
# fwego.contrib.builder.migrations.0008_change_page_params
...
# fwego.contrib.builder.migrations.0019_sub_domains
def sub_domains_0019():
    return fwego.contrib.builder.domains.models.get_default_domain_content_type().id
...
# fwego.contrib.builder.migrations.0020_migrate_existing_domains
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=(fwego.core.mixins.OrderableMixin, models.Model),
        ),
        migrations.CreateModel(
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=models.SET(
                            fwego.contrib.builder.elements.models.get_default_element_content_type
                        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("value", fwego.core.formula.field.FormulaField(default="")),
                (
                    "level",
                    models.IntegerField(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        unique=True,
                        validators=[
                            fwego.contrib.builder.domains.models.validate_domain
                        ],
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                default="/",
                max_length=255,
                validators=[fwego.contrib.builder.pages.validators.path_validation],
            ),
        ...
        migrations.CreateModel(
            ...
            bases=(fwego.core.mixins.FractionOrderableMixin, models.Model),
        ),
        migrations.AddField(
            model_name="element",
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                on_delete=models.SET(
                    fwego.contrib.builder.domains.models.get_default_domain_content_type
                ),
                related_name="builder_domains",
                to="contenttypes.contenttype",
                verbose_name="content type",
        ...
        migrations.CreateModel(
            ...
            bases=(
                fwego.core.mixins.PolymorphicContentTypeMixin,
                fwego.core.mixins.OrderableMixin,
                models.Model,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("title", fwego.core.formula.field.FormulaField(default="")),
                ("description", fwego.core.formula.field.FormulaField(default="")),
            ],
            options={
                "abstract": False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("url", fwego.core.formula.field.FormulaField(default="")),
            ],
            options={
                "abstract": False,
            },
        ...
        migrations.CreateModel(
            name="LocalFwegoUpdateRowWorkflowAction",
            fields=[
                (
                    "builderworkflowaction_ptr",
                    models.OneToOneField(
        ...
        migrations.CreateModel(
            name="LocalFwegoCreateRowWorkflowAction",
            fields=[
                (
                    "builderworkflowaction_ptr",
                    models.OneToOneField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "submit_button_label",
                    fwego.core.formula.field.FormulaField(default=""),
                ),
                (
                    "button_color",
                    models.CharField(
