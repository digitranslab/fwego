...
from fwego.contrib.builder.elements.models import CollectionField, LinkElement
from fwego.contrib.builder.elements.registries import CollectionFieldType
