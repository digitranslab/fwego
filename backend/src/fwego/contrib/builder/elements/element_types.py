...
from fwego.contrib.builder.api.elements.serializers import ChoiceOptionSerializer
...
from fwego.contrib.builder.date import FormattedDate, FormattedDateTime
from fwego.contrib.builder.elements.handler import ElementHandler
from fwego.contrib.builder.elements.mixins import (
...
from fwego.contrib.builder.elements.registries import (
    ElementType,
...
from fwego.contrib.builder.theme.theme_config_block_types import (
    TableThemeConfigBlockType,
)
from fwego.contrib.builder.types import ElementDict
from fwego.core.constants import (
    DATE_FORMAT,
    DATE_FORMAT_CHOICES,
    DATE_TIME_FORMAT,
    DATE_TIME_FORMAT_CHOICES,
)
from fwego.core.formula import (
...
from fwego.core.formula.validator import (
    ensure_array,
    ensure_boolean,
    ensure_integer,
    ensure_string_or_integer,
)
from fwego.core.registry import Instance, T
...
class FormContainerElementType(ContainerElementTypeMixin, ElementType):
    ...
    class SerializedDict(ContainerElementTypeMixin.SerializedDict):
        submit_button_label: FwegoFormula
    ...
    def serializer_field_overrides(self):
        from fwego.contrib.builder.api.theme.serializers import (
...
class RecordSelectorElementType(
    ...
    class SerializedDict(CollectionElementTypeMixin.SerializedDict):
        required: bool
        label: FwegoFormula
        default_value: FwegoFormula
        placeholder: FwegoFormula
        multiple: bool
        option_name_suffix: FwegoFormula
...
class NavigationElementManager:
    ...
    @property
    def serializer_field_overrides(self):
        from fwego.contrib.builder.api.elements.serializers import (
...
class ImageElementType(ElementType):
    ...
    class SerializedDict(ElementDict):
        ...
        image_file_id: int
        image_url: FwegoFormula
        alt_text: FwegoFormula
    ...
    def request_serializer_field_overrides(self):
        from fwego.api.user_files.serializers import UserFileField
        from fwego.contrib.builder.api.theme.serializers import (
            DynamicConfigBlockSerializer,
        )
        from fwego.contrib.builder.api.validators import image_file_validation
        from fwego.contrib.builder.theme.theme_config_block_types import (
            ImageThemeConfigBlockType,
        )
...
class ChoiceElementType(FormElementTypeMixin, ElementType):
    ...
    class SerializedDict(ElementDict):
        ...
        option_type: str
        formula_value: FwegoFormula
        formula_name: FwegoFormula
