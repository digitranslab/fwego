...
from fwego.contrib.builder.elements.models import Element, NavigationElementMixin
from fwego.contrib.builder.pages.models import Page
from fwego.core.formula.field import FormulaField
from fwego.core.mixins import OrderableMixin
...
class LocalFwegoCreateRowWorkflowAction(BuilderWorkflowServiceAction):
    ...


class LocalFwegoUpdateRowWorkflowAction(BuilderWorkflowServiceAction):
    ...


class LocalFwegoDeleteRowWorkflowAction(BuilderWorkflowServiceAction):
    ...
