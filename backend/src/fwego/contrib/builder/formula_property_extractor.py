...
from fwego.contrib.builder.formula_importer import FwegoFormulaImporter
from fwego.core.formula import FwegoFormula
from fwego.core.formula.exceptions import InvalidFwegoFormula
from fwego.core.utils import merge_dicts_no_duplicates, to_path
...
class FormulaFieldVisitor(FwegoFormulaImporter):
    """
