...
class BuilderConfig(AppConfig):
    ...
    def ready(self):
        ...
        from fwego.contrib.builder.data_sources.object_scopes import (
            BuilderDataSourceObjectScopeType,
        )
        from fwego.contrib.builder.domains.object_scopes import (
            BuilderDomainObjectScopeType,
        )
        from fwego.contrib.builder.elements.object_scopes import (
            BuilderElementObjectScopeType,
        )
        from fwego.contrib.builder.object_scopes import BuilderObjectScopeType
        from fwego.contrib.builder.pages.object_scopes import (
            BuilderPageObjectScopeType,
        )
        from fwego.contrib.builder.workflow_actions.object_scopes import (
        ...
        from fwego.contrib.builder.elements.usage_types import (
        ...
        from fwego.contrib.builder.domains.job_types import PublishDomainJobType
        ...
        import fwego.contrib.builder.ws.signals  # noqa: F403, F401
