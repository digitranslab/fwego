...
from fwego.contrib.builder.theme.registries import theme_config_block_registry
from fwego.contrib.builder.types import BuilderDict
...
def lazy_get_instance_serializer_class():
    from fwego.contrib.builder.api.serializers import BuilderSerializer
...
class BuilderApplicationType(ApplicationType):
    ...
    def init_application(self, user: AbstractUser, application: Application) -> None:
        ...
        # Create the Local Fwego integration.
