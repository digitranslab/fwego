...
from fwego.contrib.builder.elements.models import FormElement
from fwego.contrib.builder.workflow_actions.handler import (
    BuilderWorkflowActionHandler,
)
from fwego.core.formula.exceptions import FormulaRecursion, InvalidFwegoFormula
...
from fwego.core.utils import get_value_at_path
...
class DataSourceDataProviderType(DataProviderType):
    ...
    def extract_properties(self, path: List[str], **kwargs) -> Dict[str, List[str]]:
        ...
        try:
            ...
            raise InvalidFwegoFormula() from exc
...
class UserDataProviderType(DataProviderType):
    ...
    `fwego.api.user_sources.middleware.AddUserSourceUserMiddleware` django middleware.
    """
