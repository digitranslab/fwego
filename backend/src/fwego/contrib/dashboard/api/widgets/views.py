...
from fwego.contrib.dashboard.widgets.exceptions import (
    WidgetDoesNotExist,
    WidgetTypeDoesNotExist,
)
from fwego.contrib.dashboard.widgets.registries import widget_type_registry
from fwego.contrib.dashboard.widgets.service import WidgetService
