  ...
  <div class="layout__col-2-scroll layout__col-2-scroll--white-background">
    <div v-if="orderedLicenses.length === 0" class="placeholder">
      ...
      <div class="placeholder__action">
        ...
        <RedirectToFwegoModal
          :href="'https://fwego.io/get-license/' + instanceId + '/'"
          target="_blank"
          >{{ $t('licenses.getLicense') }}</RedirectToFwegoModal
        >
      </div>
      <p>
        {{ $t('licenses.fwegoInstanceId') }}
        <br />
...
import RegisterLicenseModal from '@fwego_premium/components/license/RegisterLicenseModal'
import RedirectToFwegoModal from '@fwego_premium/components/RedirectToFwegoModal'
import PremiumFeatures from '@fwego_premium/components/PremiumFeatures'
import EnterpriseFeatures from '@fwego_enterprise/components/EnterpriseFeatures'
