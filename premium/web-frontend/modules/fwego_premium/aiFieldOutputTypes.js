...
import FieldSelectOptionsSubForm from '@fwego/modules/database/components/field/FieldSelectOptionsSubForm.vue'
...
export class AIFieldOutputType extends Registerable {
  ...
  getFwegoFieldType() {
    throw new Error('The Fwego field type must be set on the AI output type.')
  }
