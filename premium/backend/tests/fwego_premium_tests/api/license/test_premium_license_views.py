...
def test_admin_list_licenses(api_client, data_fixture, django_assert_num_queries):
    ...
    with freeze_time("2021-09-01 00:00"):
        ...
        with django_assert_num_queries(3):
            ...
            assert response_json[0]["issued_to_email"] == "developers@digi-trans.org"
            ...
            assert response_json[1]["issued_to_email"] == "developers@digi-trans.org"
...
def test_admin_register_license(api_client, data_fixture):
    ...
    with freeze_time("2021-09-01 00:00"):
        ...
        assert response_json["issued_to_email"] == "developers@digi-trans.org"
