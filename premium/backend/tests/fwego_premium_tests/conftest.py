...
from fwego_premium.license.registries import LicenseType, license_type_registry
from fwego_premium.plugins import PremiumPlugin
from fakeredis import FakeRedis, FakeServer

from fwego.test_utils.pytest_conftest import *  # noqa: F403, F401


@pytest.fixture(scope="function", autouse=True)
def mock_periodic_field_update_handler_redis_client():
    redis_client_fn = "fwego.contrib.database.fields.periodic_field_update_handler._get_redis_client"
