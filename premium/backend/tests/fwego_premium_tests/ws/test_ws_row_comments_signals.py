...
import pytest
from fwego_premium.row_comments.actions import DeleteRowCommentActionType
...
from fwego.core.db import transaction_atomic


@pytest.mark.django_db(transaction=True)
@override_settings(DEBUG=True)
@patch("fwego.ws.registries.broadcast_to_channel_group")
...
def test_row_comment_updated(premium_data_fixture):
    ...
    with patch(
        "fwego.ws.registries.broadcast_to_channel_group"
