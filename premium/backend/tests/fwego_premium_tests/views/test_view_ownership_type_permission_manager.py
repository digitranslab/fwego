import pytest
from fwego_premium.permission_manager import ViewOwnershipPermissionManagerType

from fwego.core.registries import object_scope_type_registry, operation_type_registry
