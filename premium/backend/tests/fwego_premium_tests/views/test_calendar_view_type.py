...
from fwego_premium.views.models import CalendarView, CalendarViewFieldOptions
from icalendar import Calendar
from rest_framework.response import Response
from rest_framework.status import HTTP_200_OK

from fwego.contrib.database.action.scopes import ViewActionScopeType
...
from fwego.contrib.database.views.actions import UpdateViewActionType
...
def test_calendar_view_ical_feed_timestamps(
    ...
    assert feed
    assert feed.get("PRODID") == "Fwego / fwego.io"
