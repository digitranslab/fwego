...
from fwego_premium.row_comments.models import RowComment, RowCommentsNotificationMode
...
@override_settings(DEBUG=True)
@patch("fwego_premium.row_comments.signals.row_comment_created.send")
...
@pytest.mark.django_db(transaction=True)
@override_settings(DEBUG=True)
@patch("fwego_premium.row_comments.signals.row_comment_updated.send")
...
@pytest.mark.django_db(transaction=True)
@override_settings(DEBUG=True)
@patch("fwego_premium.row_comments.signals.row_comment_deleted.send")
