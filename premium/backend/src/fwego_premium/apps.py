...
class FwegoPremiumConfig(AppConfig):
    name = "fwego_premium"

    def ready(self):
        # noinspection PyUnresolvedReferences
        import fwego_premium.row_comments.receivers  # noqa: F401
        from fwego_premium.api.user.user_data_types import ActiveLicensesDataType
        from fwego_premium.row_comments.row_metadata_types import (
        ...
        from fwego.contrib.database.export.registries import table_exporter_registry
        ...
        import fwego_premium.views.signals as view_signals  # noqa: F403, F401
        import fwego_premium.ws.signals  # noqa: F403, F401
        ...
        from fwego_premium.row_comments.notification_types import (
        ...
        from fwego_premium.api.settings.settings_types import (
            InstanceWideSettingsDataType,
        )

        from fwego.api.settings.registries import settings_data_registry

        settings_data_registry.register(InstanceWideSettingsDataType())

        import fwego_premium.fields.tasks  # noqa: F401
