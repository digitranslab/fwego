...
ERROR_UNSUPPORTED_LICENSE = (
    "ERROR_UNSUPPORTED_LICENSE",
    HTTP_400_BAD_REQUEST,
    "This license version is not supported. You probably need to update your Fwego "
    "installation.",
)
ERROR_PREMIUM_LICENSE_INSTANCE_ID_MISMATCH = (
    "ERROR_PREMIUM_LICENSE_INSTANCE_ID_MISMATCH",
    HTTP_400_BAD_REQUEST,
    "The `instance_id` of the license doesn't match the instance id of Fwego copy.",
)
