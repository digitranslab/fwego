...
from fwego_premium.api.views.calendar.errors import (
    ERROR_CALENDAR_VIEW_HAS_NO_DATE_FIELD,
)
from fwego_premium.api.views.calendar.serializers import (
    ListCalendarRowsQueryParamsSerializer,
    get_calendar_view_example_response_serializer,
)
from fwego_premium.ical_utils import build_calendar
from fwego_premium.license.features import PREMIUM
from fwego_premium.license.handler import LicenseHandler
from fwego_premium.views.actions import RotateCalendarIcalSlugActionType
from fwego_premium.views.exceptions import CalendarViewHasNoDateField
from fwego_premium.views.handler import get_rows_grouped_by_date_field
from fwego_premium.views.models import CalendarView
...
from fwego.api.utils import DiscriminatorCustomFieldsMappingSerializer
from fwego.contrib.database.api.constants import (
...
from fwego.contrib.database.api.views.serializers import ViewSerializer
from fwego.contrib.database.api.views.utils import get_public_view_authorization_token
from fwego.contrib.database.fields.exceptions import (
    FieldDoesNotExist,
    FilterFieldNotFound,
)
from fwego.contrib.database.rows.registries import row_metadata_registry
...
from fwego.core.db import specific_queryset
...
class ICalView(APIView):
    ...
    def get(self, request, ical_slug: str):
        ...
        cal = build_calendar(qs, view, limit=settings.FWEGO_ICAL_VIEW_MAX_EVENTS)
        return HttpResponse(
            cal.to_ical(),
