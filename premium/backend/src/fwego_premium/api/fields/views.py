...
from fwego_premium.fields.actions import GenerateFormulaWithAIActionType
from fwego_premium.fields.models import AIField
from fwego_premium.fields.tasks import generate_ai_values_for_rows
...
from fwego.api.generative_ai.errors import (
...
from fwego.contrib.database.api.fields.errors import ERROR_FIELD_DOES_NOT_EXIST
from fwego.contrib.database.api.rows.errors import ERROR_ROW_DOES_NOT_EXIST
...
from fwego.core.generative_ai.exceptions import (
...
class GenerateFormulaWithAIView(APIView):
    ...
    @extend_schema(
        ...
        description=(
            "This endpoint generates a Fwego formula for the table related to the "
