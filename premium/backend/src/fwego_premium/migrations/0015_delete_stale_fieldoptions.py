...
def forward(apps, schema_editor):
    ...
    CalendarViewFieldOptions = apps.get_model(
        "fwego_premium", "CalendarViewFieldOptions"
    )
    KanbanViewFieldOptions = apps.get_model("fwego_premium", "KanbanViewFieldOptions")
...
class Migration(migrations.Migration):
    dependencies = [
        ("fwego_premium", "0014_add_unique_constraint_viewfieldoptions"),
    ]
