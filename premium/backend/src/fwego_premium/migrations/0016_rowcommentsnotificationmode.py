...
import fwego_premium.row_comments.models
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("fwego_premium", "0015_delete_stale_fieldoptions"),
    ]
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                fwego_premium.row_comments.models.RowCommentsNotificationModes[
                                    "MODE_ALL_COMMENTS"
                                ],
                                "All comments",
                            ),
                        ...
                        default=fwego_premium.row_comments.models.RowCommentsNotificationModes[
                            "MODE_ONLY_MENTIONS"
                        ],
