...
from fwego_premium.api.views.kanban.errors import (
    ERROR_KANBAN_VIEW_FIELD_DOES_NOT_BELONG_TO_SAME_TABLE,
)
from fwego_premium.api.views.kanban.serializers import (
...
from fwego_premium.api.views.timeline.serializers import (
...
class KanbanViewType(ViewType):
    ...
    def get_api_urls(self):
        from fwego_premium.api.views.kanban import urls as api_urls
...
class CalendarViewType(ViewType):
    ...
    def get_api_urls(self):
        from fwego_premium.api.views.calendar import urls as api_urls
...
class TimelineViewType(ViewType):
    ...
    def get_api_urls(self):
        from fwego_premium.api.views.timeline import urls as api_urls
