...
from fwego_premium.prompts import get_generate_formula_prompt
...
from .pydantic_models import FwegoFormulaModel
...
class AIFieldHandler:
    ...
    def generate_formula_with_ai(
        ...
        output_parser = JsonOutputParser(pydantic_object=FwegoFormulaModel)
