...
class AIFieldOutputType(abc.ABC, Instance):
    ...
    def fwego_field_type(self) -> str:
        """
        The Fwego field type that corresponds to this AI output type and should be
        used to do various Fwego operations like filtering, sorting, etc.
        """
    ...
    def prepare_data_sync_value(self, value: Any, field: Field, metadata: dict) -> Any:
        """
        Hook that's called when preparing the value in the local Fwego data sync.
