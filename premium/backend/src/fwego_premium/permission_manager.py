...
from fwego.core.exceptions import PermissionDenied, PermissionException
from fwego.core.handler import CoreHandler
from fwego.core.registries import PermissionManagerType, object_scope_type_registry
from fwego.core.subjects import UserSubjectType
from fwego.core.types import Actor, PermissionCheck
...
class ViewOwnershipPermissionManagerType(PermissionManagerType):
    ...
    def __init__(self):
        # Background: Fwego can be configured using
        # FWEGO_PERSONAL_VIEW_LOWEST_ROLE_ALLOWED to allow viewers and/or commenters
