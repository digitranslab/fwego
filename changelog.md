...
* [Builder] Introducing the new row aggregations service to the application builder. [#3069](https://github.com/digitranslab/fwego/-/issues/3069)
...
* Show the Fwego version in the setting page. [#2696](https://github.com/digitranslab/fwego/-/issues/2696)
...
* Fix a bug where the clear button doesn't work in workspace level audit logs. [#2866](https://github.com/digitranslab/fwego/-/issues/2866)
...
* Introduced a new element type called 'Repeat'. Given a list datasource, will repeat its child elements n number of times for each result in the datasource. [#2485](https://github.com/digitranslab/fwego/-/issues/2485)
...
* Fix a bug causing the view to crash when grouping by a multiple select and a single select field. [#2624](https://github.com/digitranslab/fwego/-/issues/2624)
...
* Resolved an issue where updating a table element with an invalid data source would cause the backend to throw an unhandled error. [#2468](https://github.com/digitranslab/fwego/-/issues/2468)
...
* Fix error fro workflow actions with no loading indicator [#2418](https://github.com/digitranslab/fwego/-/issues/2418)
...
* Fixed a bug causing the UI to freeze on clicking the already opened table link in sidebar. [#2082](https://github.com/digitranslab/fwego/-/issues/2082)
...
* Restyle tabs component [#1918](https://github.com/digitranslab/fwego/-/issues/1918)
...
* Added support for `user_field_names` in the list rows endpoint's filtering mechanism. [#510](https://github.com/digitranslab/fwego/-/issues/510)
...
* Form validator shows the correct message when a field is required. [#1475](https://github.com/digitranslab/fwego/-/issues/1475)
...
* Selecting text in models, contexts, form fields and grid view cells no longer unselects when releasing the mouse outside. [#1243](https://github.com/digitranslab/fwego/-/issues/1243)
* Duplicating a table with a removed single select option value no longer results in an error. [#1263](https://github.com/digitranslab/fwego/-/issues/1263)
* Fixed bug where the row metadata was not updated when receiving a realtime event.

### Refactors
* Replace members modal with a new settings page. [#1229](https://github.com/digitranslab/fwego/-/issues/1229)
* Frontend now install templates as an async job in background instead of using a blocking call. [#885](https://github.com/digitranslab/fwego/-/issues/885)
* Changed the add label of several buttons.

### Breaking API changes
* Changed error codes returned by the premium license API endpoints to replacing `PREMIUM_LICENSE` with `LICENSE`. [#1230](https://github.com/digitranslab/fwego/-/issues/1230)
* The "token_auth" endpoint response and "user_data_updated" messages now have an "active_licenses" key instead of "premium" indicating what licenses the user has active. [#1230](https://github.com/digitranslab/fwego/-/issues/1230)
* Changed the JWT library to fix a problem causing the refresh-tokens not working properly. [#787](https://github.com/digitranslab/fwego/-/issues/787)
* List jobs endpoint "list_job" returns now an object with jobs instead of a list of jobs. [#885](https://github.com/digitranslab/fwego/-/issues/885)


## Released (2022-09-20_1.12.1)

### New features
* Show database and table duplication progress in the left sidebar. [#1059](https://github.com/digitranslab/fwego/-/issues/1059)
* Always allow the cover image of a gallery view to be accessible by a public view [#1113](https://github.com/digitranslab/fwego/-/issues/1113)
* Add a rich preview while importing data to an existing table. [#1120](https://github.com/digitranslab/fwego/-/issues/1120)
* Made it possible to share the Kanban view publicly. [#1146](https://github.com/digitranslab/fwego/-/issues/1146)
* Added support for placeholders in form headings and fields. [#1168](https://github.com/digitranslab/fwego/-/issues/1168)
* Added link, button, get_link_label and get_link_url formula functions. [#818](https://github.com/digitranslab/fwego/-/issues/818)
* Add env vars for controlling which URLs and IPs webhooks are allowed to use. [#931](https://github.com/digitranslab/fwego/-/issues/931)
* New templates:
  * Copy Management
  * Hiking Guide
  * New Hire Onboarding
...
### Bug fixes
* Fixed a bug that breaks the link row modal when a formula is referencing a single select field. [#1111](https://github.com/digitranslab/fwego/-/issues/1111)
* Always allow the cover image of a gallery view to be accessible by a public view [#1113](https://github.com/digitranslab/fwego/-/issues/1113)
* Fixed an issue where customers with malformed file extensions were unable to snapshot or duplicate properly [#1194](https://github.com/digitranslab/fwego/-/issues/1194)
* Fixed Multiple Collaborators field renames. Now renaming the field won't recreate the field so that data is preserved.
* Plugins can now change any and all Django settings instead of just the ones set previously by Fwego.
...
### Refactors
* Formulas which referenced other aggregate formulas now will work correctly. [#1081](https://github.com/digitranslab/fwego/-/issues/1081)
* Improved file import UX for existing table. [#1120](https://github.com/digitranslab/fwego/-/issues/1120)
* Used SimpleGrid component for SelectRowModal. [#1120](https://github.com/digitranslab/fwego/-/issues/1120)


## Released (2022-09-07_1.12.0)

### New features
* Add cancel button to field update context [#1020](https://github.com/digitranslab/fwego/-/issues/1020)
* Sort fields on row select modal by the order of the first view in the related table. [#1062](https://github.com/digitranslab/fwego/-/issues/1062)
* Allow not creating a reversed relationship with the link row field. [#1063](https://github.com/digitranslab/fwego/-/issues/1063)
* Allow creating new rows when selecting a related row [#1064](https://github.com/digitranslab/fwego/-/issues/1064)
* Search automatically after 400ms when chosing a related field via the modal. [#1091](https://github.com/digitranslab/fwego/-/issues/1091)
* Added Multiple Collaborators field type. [#1119](https://github.com/digitranslab/fwego/-/issues/1119)
* Add API token authentication support to multipart and via-URL file uploads. [#255](https://github.com/digitranslab/fwego/-/issues/255)
* Introduced a premium form survey style theme. [#524](https://github.com/digitranslab/fwego/-/issues/524)
* Enable `file field` in `form` views. [#525](https://github.com/digitranslab/fwego/-/issues/525)
* Force browser language when viewing a public view. [#834](https://github.com/digitranslab/fwego/-/issues/834)
* Fields can now be duplicated with their cell values also. [#964](https://github.com/digitranslab/fwego/-/issues/964)
* Add a tooltip to applications and tables in the left sidebar to show the full name. [#986](https://github.com/digitranslab/fwego/-/issues/986)
...
### Bug fixes
* Resolve an issue with uploading a file via a URL when it contains a querystring. [#1034](https://github.com/digitranslab/fwego/-/issues/1034)
* Fixed a bug when importing Airtable base with a date field less than 1000. [#1046](https://github.com/digitranslab/fwego/-/issues/1046)
* Add new filter types 'is after today' and 'is before today'. [#1093](https://github.com/digitranslab/fwego/-/issues/1093)
* Fixed a bug that make the grid view crash when searching text and a formula field is referencing a singe-select field. [#1110](https://github.com/digitranslab/fwego/-/issues/1110)
* Prefetch field options on views that are iterated over on field update realtime events [#1113](https://github.com/digitranslab/fwego/-/issues/1113)
* Resolve circular dependency in `FieldWithFiltersAndSortsSerializer` [#1113](https://github.com/digitranslab/fwego/-/issues/1113)
* Clearing cell values multi-selected from right to left with backspace shifts selection to the right and results in wrong deletion. [#1134](https://github.com/digitranslab/fwego/-/issues/1134)
* Fixed a bug that prevent to use arrows keys in the grid view when a formula field is selected. [#1136](https://github.com/digitranslab/fwego/-/issues/1136)
* "Link to table" field does not allow submitting empty values. [#1159](https://github.com/digitranslab/fwego/-/issues/1159)
* Resolve an invalid URL in the "Backend URL mis-configuration detected" error message. [#967](https://github.com/digitranslab/fwego/-/issues/967)
...
### Refactors
* Fixed error when sharing a view publicly with sorts more than one multi-select field. [#1082](https://github.com/digitranslab/fwego/-/issues/1082)
* Fix view and fields getting out of date on realtime updates. [#1112](https://github.com/digitranslab/fwego/-/issues/1112)
* Fixed crash in gallery view with searching. [#1130](https://github.com/digitranslab/fwego/-/issues/1130)
* Users can copy/paste images into a file field. [#367](https://github.com/digitranslab/fwego/-/issues/367)
* Make it possible to copy/paste/import from/to text values for multi-select and file fields. [#913](https://github.com/digitranslab/fwego/-/issues/913)
...
### New features
* Replaced all custom alert code with `Alert` component [#1016](https://github.com/digitranslab/fwego/-/issues/1016)
* Added a new "is months ago filter". [#1018](https://github.com/digitranslab/fwego/-/issues/1018)
* Added a new "is years ago filter". [#1019](https://github.com/digitranslab/fwego/-/issues/1019)
* Added public gallery view [#1057](https://github.com/digitranslab/fwego/-/issues/1057)
* Made it possible to select the entire row via the row context menu. [#1061](https://github.com/digitranslab/fwego/-/issues/1061)
* Show modal when the users clicks on a deactivated premium features. [#1066](https://github.com/digitranslab/fwego/-/issues/1066)
* Introduced environment variable to disable Google docs file preview. [#1074](https://github.com/digitranslab/fwego/-/issues/1074)
* Add ability to create and restore snapshots. [#141](https://github.com/digitranslab/fwego/-/issues/141)
* Added option to use view's filters and sorting when listing rows. [#190](https://github.com/digitranslab/fwego/-/issues/190)
* Made it possible to import data into an existing table. [#342](https://github.com/digitranslab/fwego/-/issues/342)
* Add configs and docs for VSCode setup. [#854](https://github.com/digitranslab/fwego/-/issues/854)
* Allow users to use row id in the form redirect URL. [#871](https://github.com/digitranslab/fwego/-/issues/871)
* When viewing an expanded row switch to a unique URL which links to that row. [#938](https://github.com/digitranslab/fwego/-/issues/938)
* Added a new `ClientUndoRedoActionGroupId` request header to bundle multiple actions in a single API call. [#951](https://github.com/digitranslab/fwego/-/issues/951)
* Added `in this week` filter [#954](https://github.com/digitranslab/fwego/-/issues/954)
* Applications can now be duplicated. [#960](https://github.com/digitranslab/fwego/-/issues/960)
* Tables can now be duplicated. [#961](https://github.com/digitranslab/fwego/-/issues/961)
...
### Bug fixes
* Disable table import field type guessing and instead always import as text fields. [#1050](https://github.com/digitranslab/fwego/-/issues/1050)
* Add better error handling to row count job. [#1051](https://github.com/digitranslab/fwego/-/issues/1051)
* Upgrade the images provided in our example docker-compose files to be the latest and most secure. [#1056](https://github.com/digitranslab/fwego/-/issues/1056)
* Fix the perm delete trash cleanup job failing for self linking tables. [#1075](https://github.com/digitranslab/fwego/-/issues/1075)
* Fixed changing field type to unsupported form view bug. [#1078](https://github.com/digitranslab/fwego/-/issues/1078)
* Fix backspace and delete keys breaking after selecting a formula text cell. [#1085](https://github.com/digitranslab/fwego/-/issues/1085)
* Fix some rare errors when combining the if and divide formula functions. [#1086](https://github.com/digitranslab/fwego/-/issues/1086)
* Don't allow invalid aggregate formulas from being created causing errors when inserting rows. [#1089](https://github.com/digitranslab/fwego/-/issues/1089)
* Ensure the latest error is always shown when clicking the formula refresh options link. [#1092](https://github.com/digitranslab/fwego/-/issues/1092)
* Display round and trunc functions in the formula edit modal, rename int to trunc and make these functions handle weird inputs better. [#1095](https://github.com/digitranslab/fwego/-/issues/1095)
* Fixed duplicating view with that depends on select options mapping. [#1104](https://github.com/digitranslab/fwego/-/issues/1104)
* Fixed problem causing kanban view duplication to fail silently. [#1109](https://github.com/digitranslab/fwego/-/issues/1109)
* Fixed problem when new webhooks would be sent twice with both old and new payload.

### Breaking API changes
* API endpoint `/database/views/grid/${viewSlug}/public/info/` has been replaced by `/database/views/${viewSlug}/public/info/` [#1057](https://github.com/digitranslab/fwego/-/issues/1057)
* Removed `primary` from all `components`and `stores` where it isn't absolutely required. [#1057](https://github.com/digitranslab/fwego/-/issues/1057)
* Fix not being able to paste multiple cells when a formula field of array or single select type was in an error state. [#1084](https://github.com/digitranslab/fwego/-/issues/1084)
* Concurrent field updates will now respond with a 409 instead of blocking until the previous update finished, set the env var FWEGO_WAIT_INSTEAD_OF_409_CONFLICT_ERROR to revert to the old behaviour. [#1097](https://github.com/digitranslab/fwego/-/issues/1097)
...
### New features
* Made the styling of the dashboard cleaner and more efficient. [#1023](https://github.com/digitranslab/fwego/-/issues/1023)
* Redirect to signup instead of the login page if there are no admin users. [#1035](https://github.com/digitranslab/fwego/-/issues/1035)
* Add startup check ensuring FWEGO_PUBLIC_URL and related variables are correct. [#1041](https://github.com/digitranslab/fwego/-/issues/1041)
* Link to table field can now link rows in the same table. [#798](https://github.com/digitranslab/fwego/-/issues/798)
* Added prefill query parameters for forms. [#852](https://github.com/digitranslab/fwego/-/issues/852)
* Add support for horizontal scrolling in grid views pressing Shift + mouse-wheel. [#867](https://github.com/digitranslab/fwego/-/issues/867)
* Added possibility to delete own user account [#880](https://github.com/digitranslab/fwego/-/issues/880)
* Added formula round and int functions. [#891](https://github.com/digitranslab/fwego/-/issues/891)
* Views can be duplicated. [#962](https://github.com/digitranslab/fwego/-/issues/962)
* Add basic field duplication. [#964](https://github.com/digitranslab/fwego/-/issues/964)
* Add the ability to disable the model cache with the new FWEGO_DISABLE_MODEL_CACHE env variable.
* Added API exception registry that allows plugins to provide custom exception mappings for the REST API.
* Added Link Row contains filter. [874](https://github.com/digitranslab/fwego/-/issues/874)
...
* Allow to import more than 15Mb. [949](ttps://github.com/digitranslab/fwego/-/issues/949)
* `./dev.sh all_in_one_dev` now starts a hot reloading dev mode using the all-in-one image.
* Made it clearer that you're navigating to fwego.io when clicking the "Get a license"
button.
* Made it possible to extend the app layout.
* Made it possible to extend the register page.

### Bug fixes
* Fix regex_replace formula function allowing invalid types as params. [#1024](https://github.com/digitranslab/fwego/-/issues/1024)
* Fix newly imported templates missing field dependencies for some link row fields. [#1025](https://github.com/digitranslab/fwego/-/issues/1025)
* Fix converting a link row not updating dependants on the reverse side. [#1026](https://github.com/digitranslab/fwego/-/issues/1026)
* Fix lookup field conversions deleting all of its old field dependencies. [#1036](https://github.com/digitranslab/fwego/-/issues/1036)
* Fix refresh formula options button always being shown initially. [#1037](https://github.com/digitranslab/fwego/-/issues/1037)
* Fix views becoming inaccessible due to race condition when invalidating model cache. [#1040](https://github.com/digitranslab/fwego/-/issues/1040)
* Fix get_human_readable_value crashing for some formula types. [#1042](https://github.com/digitranslab/fwego/-/issues/1042)
* Upload modal no longer closes when removing a file. [#569](https://github.com/digitranslab/fwego/-/issues/569)
* Fix rare formula bug with multiple different formulas and view filters in one table. [#801](https://github.com/digitranslab/fwego/-/issues/801)
* Added FormulaField to the options for the primary field. [#859](https://github.com/digitranslab/fwego/-/issues/859)
* Treat null values as zeros for numeric formulas. [#886](https://github.com/digitranslab/fwego/-/issues/886)
* Fix formula bug caused when looking up date intervals. [#924](https://github.com/digitranslab/fwego/-/issues/924)
* Fix formula bugs caused by unsupported generation of BC dates. [#952](https://github.com/digitranslab/fwego/-/issues/952)
* Fixed URL fields not being available in lookup fields. [#984](https://github.com/digitranslab/fwego/-/issues/984)
* Add debugging commands/options for inspecting tables and updating formulas.
* API returns a nicer error if URL trailing slash is missing. [798](https://github.com/digitranslab/fwego/-/issues/798)
* Fix dependant fields not being updated if the other side of a link row field changed. [918](https://github.com/digitranslab/fwego/-/issues/918)
...
* Fix nested aggregate formulas not calculating results or causing errors. [683](https://github.com/digitranslab/fwego/-/issues/683)
...
* Added FWEGO_TRIGGER_SYNC_TEMPLATES_AFTER_MIGRATION environment variable and now
do the sync_templates task in the background after migration to massively speedup
first time Fwego startup speed.
...
### New features
* Add loading bar when syncing templates to make it obvious Fwego is still loading.
* Added 0.0.0.0 and 127.0.0.1 as ALLOWED_HOSTS for connecting to the Fwego backend
* Added a new FWEGO_EXTRA_ALLOWED_HOSTS optional comma separated environment variable
...
* Added new environment variable FWEGO_FILE_UPLOAD_SIZE_LIMIT_MB
...
* Fix slowdown in large Fwego instances as the generated model cache got large.
...
* Fixed translations in emails sent by Fwego.
* Fixed webhook test call failing when request body is empty.
* Improved backup_fwego splitting multiselect through tables in separate batches.
...
* The standalone `fwego/backend` image when used to run a celery service now defaults
...
* When the FWEGO_AMOUNT_OF_WORKERS env variable is set to blank, the amount of worker
...
### New features
* Fix the Fwego Heroku install filling up the hobby postgres by disabling template
syncing by default.
...
* Add the all-in-one Fwego docker image.
...
listens by default on 0.0.0.0:80 with a Caddy reverse proxy, use FWEGO_PUBLIC_URL
and FWEGO_CADDY_ADDRESSES now to configure a domain with optional auto https.
...
* Migrate the Fwego Cloudron and Heroku images to work from the all-in-one.
...
* Rework Fwego docker images so they can be built and tested by gitlab CI.
...
* Fix vuelidate issues when fwego/web-frontend used as dependency.
...
* Fixed migration failing when upgrading a version of Fwego installed using Postgres
10 or lower.
...
* **Breaking Change**: Fwego's `docker-compose.yml` container names have changed to
no longer be hardcoded to prevent naming clashes.
* **Breaking Change**: Fwego's `docker-compose.yml` now allows setting the MEDIA_URL
...
* Added steps on how to configure Fwego to send emails in the install-on-ubuntu guide.
...
* Fixed nuxt not restarting correctly using the provided Fwego supervisor config file.
...
web-frontend.
* The internal setting allowing Fwego to run with the user tables in a separate
...
### New features
* **Breaking Change**: Fwego's `docker-compose.yml` no longer exposes ports for
the `db`, `mjml` and `redis` containers for security reasons.
* **Breaking Change**: `docker-compose.yml` will by default only expose Fwego on
...
* Support building Fwego out of the box on Ubuntu by lowering the required docker
version to build Fwego down to 19.03.
...
* **Premium**: Added group admin area allowing management of all fwego groups.
...
* Added `fill_users` admin management command which fills fwego with fake users.
...
* **Premium**: Added user admin area allowing management of all fwego users.
* Reworked Fwego's Docker setup to be easier to use, faster to build and more secure.
